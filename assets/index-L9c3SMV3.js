const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./doorViewController-tVd04-3o.js","./deviceController-ChysC8qf.js","./alarmDscViewController-Bk7mfU1g.js"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const An=new vs("@firebase/auth");function jd(n,...e){An.logLevel<=I.WARN&&An.warn(`Auth (${wt}): ${n}`,...e)}function _n(n,...e){An.logLevel<=I.ERROR&&An.error(`Auth (${wt}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Et{constructor(){this.providerId=Et.PROVIDER_ID}static credential(e,t){return Ht._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const i=ks.parseLink(t);return m(i,"argument-error"),Ht._fromEmailAndCode(e,i.code,i.tenantId)}}Et.PROVIDER_ID="password";Et.EMAIL_PASSWORD_SIGN_IN_METHOD="password";Et.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
