 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xt(n){return JSON.parse(n)}function O(n){return JSON.stringify(n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const In=new Map,_d=new Map,Vi=new Map;function Nr(n,e){try{n.container.addComponent(e)}catch(t){ge.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function te(n){const e=n.name;if(Vi.has(e))return ge.debug(`There were multiple attempts to register component ${e}.`),!1;Vi.set(e,n);for(const t of In.values())Nr(t,n);for(const t of _d.values())Nr(t,n);return!0}function Xe(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function J(n){return n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _t=gd;function ca(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const i=Object.assign({name:Bi,automaticDataCollectionEnabled:!1},e),s=i.name;if(typeof s!="string"||!s)throw ke.create("bad-app-name",{appName:String(s)});if(t||(t=ea()),!t)throw ke.create("no-options");const r=In.get(s);if(r){if(bn(t,r.options)&&bn(i,r.config))return r;throw ke.create("duplicate-app",{appName:s})}const o=new Su(s);for(const c of Vi.values())o.addComponent(c);const a=new yd(t,i,o);return In.set(s,a),a}function Yn(n=Bi){const e=In.get(n);if(!e&&n===Bi&&ea())return ca();if(!e)throw ke.create("no-app",{appName:n});return e}function $(n,e,t){var i;let s=(i=md[n])!==null&&i!==void 0?i:n;t&&(s+=`-${t}`);const r=s.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${s}" with version "${e}":`];r&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ge.warn(a.join(" "));return}te(new q(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qt{constructor(e,t){this.shortDelay=e,this.longDelay=t,me(t>e,"Short delay should be less than long delay!"),this.isMobile=ds()||na()}get(){return Md()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _s(n,e){me(n.emulator,"Emulator should always be set here");const{url:t}=n.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ud=new Qt(3e4,6e4);function ve(n,e){return n.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:n.tenantId}):e}async function ye(n,e,t,i,s={}){return pa(n,s,async()=>{let r={},o={};i&&(e==="GET"?o=i:r={body:JSON.stringify(i)});const a=mt(Object.assign({key:n.config.apiKey},o)).slice(1),c=await n._getAdditionalHeaders();c["Content-Type"]="application/json",n.languageCode&&(c["X-Firebase-Locale"]=n.languageCode);const l=Object.assign({method:e,headers:c},r);return cu()||(l.referrerPolicy="no-referrer"),fa.fetch()(ga(n,n.config.apiHost,t,a),l)})}async function pa(n,e,t){n._canInitEmulator=!1;const i=Object.assign(Object.assign({},Fd),e);try{const s=new Vd(n),r=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw un(n,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const a=r.ok?o.errorMessage:o.error.message,[c,l]=a.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw un(n,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw un(n,"email-already-in-use",o);if(c==="USER_DISABLED")throw un(n,"user-disabled",o);const u=i[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(l)throw gs(n,u,l);G(n,u)}}catch(s){if(s instanceof se)throw s;G(n,"network-request-failed",{message:String(s)})}}async function Xt(n,e,t,i,s={}){const r=await ye(n,e,t,i,s);return"mfaPendingCredential"in r&&G(n,"multi-factor-auth-required",{_serverResponse:r}),r}function ga(n,e,t,i){const s=`${e}${t}?${i}`;return n.config.emulator?_s(n.config,s):`${n.config.apiScheme}://${s}`}function Bd(n){switch(n){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class Vd{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,i)=>{this.timer=setTimeout(()=>i(X(this.auth,"network-request-failed")),Ud.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function un(n,e,t){const i={appName:n.name};t.email&&(i.email=t.email),t.phoneNumber&&(i.phoneNumber=t.phoneNumber);const s=X(n,e,i);return s.customData._tokenResponse=t,s}function Lr(n){return n!==void 0&&n.enterprise!==void 0}class Wd{constructor(e){if(this.siteKey="",this.recaptchaEnforcementState=[],e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.recaptchaEnforcementState=e.recaptchaEnforcementState}getProviderEnforcementState(e){if(!this.recaptchaEnforcementState||this.recaptchaEnforcementState.length===0)return null;for(const t of this.recaptchaEnforcementState)if(t.provider&&t.provider===e)return Bd(t.enforcementState);return null}isProviderEnabled(e){return this.getProviderEnforcementState(e)==="ENFORCE"||this.getProviderEnforcementState(e)==="AUDIT"}}async function Hd(n,e){return ye(n,"GET","/v2/recaptchaConfig",ve(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $d(n,e){return ye(n,"POST","/v1/accounts:delete",e)}async function ma(n,e){return ye(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xr=new Map;function ue(n){me(n instanceof Function,"Expected a class definition");let e=xr.get(n);return e?(me(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,xr.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pn(n,e,t){return`firebase:${n}:${e}:${t}`}class st{constructor(e,t,i){this.persistence=e,this.auth=t,this.userKey=i;const{config:s,name:r}=this.auth;this.fullUserKey=pn(this.userKey,s.apiKey,r),this.fullPersistenceKey=pn("persistence",s.apiKey,r),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?le._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,i="authUser"){if(!t.length)return new st(ue(Fr),e,i);const s=(await Promise.all(t.map(async l=>{if(await l._isAvailable())return l}))).filter(l=>l);let r=s[0]||ue(Fr);const o=pn(i,e.config.apiKey,e.name);let a=null;for(const l of t)try{const u=await l._get(o);if(u){const d=le._fromJSON(e,u);l!==r&&(a=d),r=l;break}}catch{}const c=s.filter(l=>l._shouldAllowMigration);return!r._shouldAllowMigration||!c.length?new st(r,e,i):(r=c[0],a&&await r._set(o,a.toJSON()),await Promise.all(t.map(async l=>{if(l!==r)try{await l._remove(o)}catch{}})),new st(r,e,i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eh(n,e={}){return ye(n,"GET","/v2/passwordPolicy",ve(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dh(n,e){const t=Xe(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),r=t.getOptions();if(bn(r,e??{}))return s;G(s,"already-initialized")}return t.initialize({options:e})}function hh(n,e){const t=(e==null?void 0:e.persistence)||[],i=(Array.isArray(t)?t:[t]).map(ue);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(i,e==null?void 0:e.popupRedirectResolver)}function fh(n,e,t){const i=we(n);m(i._canInitEmulator,i,"emulator-config-failed"),m(/^https?:\/\//.test(e),i,"invalid-emulator-scheme");const s=!1,r=Na(e),{host:o,port:a}=ph(e),c=a===null?"":`:${a}`;i.config.emulator={url:`${r}//${o}${c}/`},i.settings.appVerificationDisabledForTesting=!0,i.emulatorConfig=Object.freeze({host:o,port:a,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:s})}),gh()}function Na(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function ph(n){const e=Na(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const i=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(i);if(s){const r=s[1];return{host:r,port:Wr(i.substr(r.length+1))}}else{const[r,o]=i.split(":");return{host:r,port:Wr(o)}}}function Wr(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function gh(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ws{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return ce("not implemented")}_getIdTokenResponse(e){return ce("not implemented")}_linkToIdToken(e,t){return ce("not implemented")}_getReauthenticationResolver(e){return ce("not implemented")}}async function mh(n,e){return ye(n,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _h(n,e){return Xt(n,"POST","/v1/accounts:signInWithPassword",ve(n,e))}async function Ra(n,e){return ye(n,"POST","/v1/accounts:sendOobCode",ve(n,e))}async function vh(n,e){return Ra(n,e)}async function yh(n,e){return Ra(n,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wh(n,e){return Xt(n,"POST","/v1/accounts:signInWithEmailLink",ve(n,e))}async function Eh(n,e){return Xt(n,"POST","/v1/accounts:signInWithEmailLink",ve(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rt(n,e){return Xt(n,"POST","/v1/accounts:signInWithIdp",ve(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ce extends Zt{constructor(){super("twitter.com")}static credential(e,t){return $e._fromParams({providerId:Ce.PROVIDER_ID,signInMethod:Ce.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return Ce.credentialFromTaggedObject(e)}static credentialFromError(e){return Ce.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:i}=e;if(!t||!i)return null;try{return Ce.credential(t,i)}catch{return null}}}Ce.TWITTER_SIGN_IN_METHOD="twitter.com";Ce.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ch(n,e){return Xt(n,"POST","/v1/accounts:signUp",ve(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Oa(n,e,t=!1){if(J(n.app))return Promise.reject(fe(n));const i="signIn",s=await Pa(n,i,e),r=await je._fromIdTokenResponse(n,i,s);return t||await n._updateCurrentUser(r.user),r}async function Ah(n,e){return Oa(we(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function La(n){const e=we(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Nh(n,e,t){const i=we(n),s={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};t&&Da(i,s,t),await Sn(i,s,"getOobCode",yh)}async function Rh(n,e,t){if(J(n.app))return Promise.reject(fe(n));const i=we(n),o=await Sn(i,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Ch).catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&La(n),c}),a=await je._fromIdTokenResponse(i,"signIn",o);return await i._updateCurrentUser(a.user),a}function Ph(n,e,t){return J(n.app)?Promise.reject(fe(n)):Ah(A(n),vt.credential(e,t)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&La(n),i})}async function Ma(n,e){const t=A(n),s={requestType:"VERIFY_EMAIL",idToken:await n.getIdToken()};e&&Da(t.auth,s,e);const{email:r}=await vh(t.auth,s);r!==n.email&&await n.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ja(n,e){return e?ue(e):(m(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qa{constructor(e,t,i,s,r=!1){this.auth=e,this.resolver=i,this.user=s,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:i,postBody:s,tenantId:r,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:t,sessionId:i,tenantId:r||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Jh;case"linkViaPopup":case"linkViaRedirect":return Xh;case"reauthViaPopup":case"reauthViaRedirect":return Qh;default:G(this.auth,"internal-error")}}resolve(e){me(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){me(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hf(n,e={}){return ye(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ya=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Kf(e)}}catch{}return new Yf},Be=Ya("localStorage"),Jf=Ya("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,`
FIREBASE: `))}restoreState_(){this.tryAuth(),this.tryAppCheck();for(const e of this.listens.values())for(const t of e.values())this.sendListen_(t);for(let e=0;e<this.outstandingPuts_.length;e++)this.outstandingPuts_[e]&&this.sendPut_(e);for(;this.onDisconnectRequestQueue_.length;){const e=this.onDisconnectRequestQueue_.shift();this.sendOnDisconnect_(e.action,e.pathString,e.data,e.onComplete)}for(let e=0;e<this.outstandingGets_.length;e++)this.outstandingGets_[e]&&this.sendGet_(e)}sendConnectStats_(){const e={};let t="js";e["sdk."+t+"."+Ka.replace(/\./g,"-")]=1,ds()?e["framework.cordova"]=1:na()&&(e["framework.reactnative"]=1),this.reportStats(e)}shouldReconnect_(){const e=Pn.getInstance().currentlyOnline();return Mi(this.interruptReasons_)&&e}}pe.nextPersistentConnectionId_=0;pe.nextConnectionId_=0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Si;const tt={};class de{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return p(tt&&R,"ChildrenNode.ts has not been loaded"),Si=Si||new de({".priority":tt},{".priority":R}),Si}get(e){const t=lt(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof H?t:null}hasIndex(e){return re(this.indexSet_,e.toString())}addIndex(e,t){p(e!==at,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=t.getIterator(w.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=On(i,e.getCompare()):a=tt;const c=e.toString(),l=Object.assign({},this.indexSet_);l[c]=e;const u=Object.assign({},this.indexes_);return u[c]=a,new de(u,l)}addToIndexes(e,t){const i=En(this.indexes_,(s,r)=>{const o=lt(this.indexSet_,r);if(p(o,"Missing index implementation for "+r),s===tt)if(o.isDefinedOn(e.node)){const a=[],c=t.getIterator(w.Wrap);let l=c.getNext();for(;l;)l.name!==e.name&&a.push(l),l=c.getNext();return a.push(e),On(a,o.getCompare())}else return tt;else{const a=t.get(e.name);let c=s;return a&&(c=c.remove(new w(e.name,a))),c.insert(e,e.node)}});return new de(i,this.indexSet_)}removeFromIndexes(e,t){const i=En(this.indexes_,s=>{if(s===tt)return s;{const r=t.get(e.name);return r?s.remove(new w(e.name,r)):s}});return new de(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eg=!0;function P(n,e=null){if(n===null)return _.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),p(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new L(t,P(e))}if(!(n instanceof Array)&&eg){const t=[];let i=!1;if(F(n,(o,a)=>{if(o.substring(0,1)!=="."){const c=P(a);c.isEmpty()||(i=i||!c.getPriority().isEmpty(),t.push(new w(o,c)))}}),t.length===0)return _.EMPTY_NODE;const r=On(t,Gp,o=>o.name,xs);if(i){const o=On(t,R.getCompare());return new _(r,P(e),new de({".priority":o},{".priority":R}))}else return new _(r,P(e),de.Default)}else{let t=_.EMPTY_NODE;return F(n,(i,s)=>{if(re(n,i)&&i.substring(0,1)!=="."){const r=P(s);(r.isLeafNode()||!r.isEmpty())&&(t=t.updateImmediateChild(i,r))}}),t.updatePriority(P(e))}}Kp(P);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ng extends Zn{compare(e,t){const i=e.node.compareTo(t.node);return i===0?Ze(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return w.MIN}maxPost(){return w.MAX}makePost(e,t){const i=P(e);return new w(t,i)}toString(){return".value"}}const ig=new ng;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ei(n,e){return{eventCache:n,serverCache:e}}function Ot(n,e,t,i){return ei(new Pe(e,t,i),n.serverCache)}function Sc(n,e,t,i){return ei(n.eventCache,new Pe(e,t,i))}function xn(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function ze(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Vn;class Mc{constructor(){this.views=new Map}}function Kg(n){p(!Vn,"__referenceConstructor has already been defined"),Vn=n}function Yg(){return p(Vn,"Reference.ts has not been loaded"),Vn}function Jg(n){return n.views.size===0}function qs(n,e,t,i){const s=e.source.queryId;if(s!==null){const r=n.views.get(s);return p(r!=null,"SyncTree gave us an op for an invalid query."),So(r,e,t,i)}else{let r=[];for(const o of n.views.values())r=r.concat(So(o,e,t,i));return r}}function xc(n,e,t,i,s){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let a=Fn(t,s?i:null),c=!1;a?c=!0:i instanceof _?(a=Hs(t,i),c=!1):(a=_.EMPTY_NODE,c=!1);const l=ei(new Pe(a,c,!1),new Pe(i,s,!1));return new Hg(e,l)}return o}function Qg(n,e,t,i,s,r){const o=xc(n,e,i,s,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),Gg(o,t),zg(o,t)}function Xg(n,e,t,i){const s=e._queryIdentifier,r=[];let o=[];const a=Oe(n);if(s==="default")for(const[c,l]of n.views.entries())o=o.concat(Co(l,t,i)),To(l)&&(n.views.delete(c),l.query._queryParams.loadsAllData()||r.push(l.query));else{const c=n.views.get(s);c&&(o=o.concat(Co(c,t,i)),To(c)&&(n.views.delete(s),c.query._queryParams.loadsAllData()||r.push(c.query)))}return a&&!Oe(n)&&r.push(new(Yg())(e._repo,e._path)),{removed:r,events:o}}function Fc(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function Ne(n,e){let t=null;for(const i of n.views.values())t=t||qg(i,e);return t}function Uc(n,e){if(e._queryParams.loadsAllData())return ni(n);{const i=e._queryIdentifier;return n.views.get(i)}}function Bc(n,e){return Uc(n,e)!=null}function Oe(n){return ni(n)!=null}function ni(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zm{constructor(e,t,i,s){this.eventType=e,this.eventRegistration=t,this.snapshot=i,this.prevName=s}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+O(this.snapshot.exportVal())}}class Km{constructor(e,t,i){this.eventRegistration=e,this.error=t,this.path=i}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class or{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return E(this._path)?null:Ds(this._path)}get ref(){return new Ee(this._repo,this._path)}get _queryIdentifier(){const e=_o(this._queryParams),t=Ns(e);return t==="{}"?"default":t}get _queryObject(){return _o(this._queryParams)}isEqual(e){if(e=A(e),!(e instanceof or))return!1;const t=this._repo===e._repo,i=Ls(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+xp(this._path)}}class Ee extends or{constructor(e,t){super(e,t,new Us,!1)}get parent(){const e=_c(this._path);return e===null?null:new Ee(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class zt{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new T(e),i=ns(this.ref,e);return new zt(this._node.getChild(t),i,R)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new zt(s,ns(this.ref,i),R)))}hasChild(e){const t=new T(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function D(n,e){return n=A(n),n._checkNotDeleted("ref"),e!==void 0?ns(n._root,e):n._root}function ns(n,e){return n=A(n),y(n._path)===null?Cm("child","path",e):Qc("child","path",e),new Ee(n._repo,N(n._path,e))}function Ym(n){return Xc("remove",n._path),Ve(n,null)}function Ve(n,e){n=A(n),Xc("set",n._path),bm("set",e,n._path);const t=new Jt;return xm(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function ar(n,e){Tm("update",e,n._path);const t=new Jt;return Fm(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function ne(n){n=A(n);const e=new rl(()=>{}),t=new li(e);return Mm(n._repo,n,t).then(i=>new zt(i,new Ee(n._repo,n._path),n._queryParams.getIndex()))}class li{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new zm("value",this,new zt(e.snapshotNode,new Ee(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Km(this,e,t):null}matches(e){return e instanceof li?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Jm(n,e,t,i,s){const r=new rl(t,void 0),o=new li(r);return Bm(n._repo,n,o),()=>Vm(n._repo,n,o)}function Oo(n,e,t,i){return Jm(n,"value",e)}Kg(Ee);Zg(Ee);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qm="FIREBASE_DATABASE_EMULATOR_HOST",is={};let Xm=!1;function Zm(n,e,t,i){n.repoInfo_=new cc(`${e}:${t}`,!1,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0),i&&(n.authTokenProvider_=i)}function e_(n,e,t,i,s){let r=i||n.options.databaseURL;r===void 0&&(n.options.projectId||_e("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),x("Using default host for project ",n.options.projectId),r=`${n.options.projectId}-default-rtdb.firebaseio.com`);let o=Po(r,s),a=o.repoInfo,c;typeof process<"u"&&Xr&&(c=Xr[Qm]),c?(r=`http://${c}?ns=${a.namespace}`,o=Po(r,s),a=o.repoInfo):o.repoInfo.secure;const l=new up(n.name,n.options,e);Sm("Invalid Firebase Database URL",o),E(o.path)||_e("Database URL must point to the root of a Firebase Database (not including a child path).");const u=n_(a,n,l,new lp(n.name,t));return new i_(u,n)}function t_(n,e){const t=is[e];(!t||t[n.key]!==n)&&_e(`Database ${e}(${n.repoInfo_}) has already been deleted.`),Wm(n),delete t[n.key]}function n_(n,e,t,i){let s=is[e.name];s||(s={},is[e.name]=s);let r=s[n.toURLString()];return r&&_e("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new Pm(n,Xm,t,i),s[n.toURLString()]=r,r}class i_{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Om(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Ee(this._repo,b())),this._rootInternal}_delete(){return this._rootInternal!==null&&(t_(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&_e("Cannot call "+e+" on a deleted database.")}}function cr(n=Yn(),e){const t=Xe(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const i=Zo("database");i&&s_(t,...i)}return t}function s_(n,e,t,i={}){n=A(n),n._checkNotDeleted("useEmulator"),n._instanceStarted&&_e("Cannot call useEmulator() after instance has already been initialized.");const s=n._repoInternal;let r;if(s.repoInfo_.nodeAdmin)i.mockUserToken&&_e('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new _n(_n.OWNER);else if(i.mockUserToken){const o=typeof i.mockUserToken=="string"?i.mockUserToken:au(i.mockUserToken,n.app.options.projectId);r=new _n(o)}Zm(s,e,t,r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function r_(n){zf(_t),te(new q("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return e_(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),$(Zr,eo,n),$(Zr,eo,"esm2017")}pe.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};pe.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};r_();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oe(n){const e=new Uint8Array(n);return btoa(String.fromCharCode(...e)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function mv(n){const e="=".repeat((4-n.length%4)%4),t=(n+e).replace(/\-/g,"+").replace(/_/g,"/"),i=atob(t),s=new Uint8Array(i.length);for(let r=0;r<i.length;++r)s[r]=i.charCodeAt(r);return s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function qo(n=Yn()){return zv().then(e=>{if(!e)throw U.create("unsupported-browser")},e=>{throw U.create("indexed-db-unsupported")}),Xe(A(n),"messaging").getImmediate()}async function Yv(n,e){return n=A(n),Ul(n,e)}function Jv(n,e){return n=A(n),Kv(n,e)}Gv();cr();const cn="fcm_token",Je="fcm_subscriptions";let He=null,Mt=null;async function Bl(){if("serviceWorker"in navigator)try{const n=new URL("./firebase-messaging-sw.js",window.location.href).toString();Mt=await navigator.serviceWorker.register(n),He=qo(De,Mt),console.log("✅ Messaging inicializado con SW en:",n)}catch(n){console.warn("⚠️ Messaging no disponible:",n.message)}else try{He=qo(De)}catch(n){console.warn("⚠️ Messaging no disponible:",n.message)}}Bl();async function Qv(){if((!He||!Mt)&&await Bl(),!He||!Mt)return{success:!1,error:"Messaging no disponible"};try{if(await Notification.requestPermission()==="granted"){const e=await Yv(He,{vapidKey:"BGqsW_ZEnJVC5kfKwtLdz6QUhhciFu53Z-ObyRwNsWscwYNA14eBFHxNn1HFVxsGSUpniXgnddgsRbGfqcmuQyI",serviceWorkerRegistration:Mt});return e?(localStorage.setItem(cn,e),{success:!0,token:e}):{success:!1,error:"No se pudo obtener el token"}}return{success:!1,error:"Permiso denegado"}}catch(n){return console.error("❌ Error solicitando permiso:",n),{success:!1,error:n.message}}}async function Xv(n,e){const t=localStorage.getItem(cn);if(!t)return;const i=JSON.parse(localStorage.getItem(Je)||"{}"),s=ur(De),r=dr(s,"subscribeToSerialTopic");for(const o of e)if(i[o]!==t)try{await r({serial:o,token:t}),i[o]=t,console.log("✅ Suscrito al topic",o)}catch(a){console.warn("⚠️ No se pudo suscribir al topic",o,a.message)}for(const o of Object.keys(i))e.includes(o)||delete i[o];localStorage.setItem(Je,JSON.stringify(i))}async function Zv(n,e){const t=localStorage.getItem(cn);if(!t)return;const i=JSON.parse(localStorage.getItem(Je)||"{}");if(i[e]===t)return;const s=ur(De),r=dr(s,"subscribeToSerialTopic");try{await r({serial:e,token:t}),i[e]=t,localStorage.setItem(Je,JSON.stringify(i)),console.log("✅ Suscrito al nuevo topic",e)}catch(o){console.warn("⚠️ No se pudo suscribir al topic",e,o.message)}}async function sy(n){const e=localStorage.getItem(cn);if(!e)return{success:!1,error:"No hay token"};const t=ur(De),i=dr(t,"unsubscribeFromSerialTopic");try{await i({serial:n,token:e});const s=JSON.parse(localStorage.getItem(Je)||"{}");return delete s[n],localStorage.setItem(Je,JSON.stringify(s)),{success:!0}}catch(s){return console.error("❌ Error desuscribiendo:",s),{success:!1,error:s.message}}}function Go(){localStorage.removeItem(cn),localStorage.removeItem(Je)}function ey(n){He&&Jv(He,e=>n(e))}class ty{constructor(){this.currentView="login"}showView(e){var t;document.querySelectorAll(".auth-view").forEach(i=>i.classList.remove("active")),(t=document.getElementById(`${e}-view`))==null||t.classList.add("active"),this.currentView=e,document.querySelectorAll(".auth-error").forEach(i=>{i.classList.remove("show"),i.textContent=""})}async handleLogin(e){e.preventDefault();const t=document.getElementById("login-email").value,i=document.getElementById("login-password").value,s=document.getElementById("remember-me").checked,r=document.getElementById("login-error"),o=document.getElementById("login-submit");if(!vn(t)){this.showInputError("login-email","Ingresa un correo válido");return}if(!os(i)){this.showInputError("login-password","Mínimo 6 caracteres");return}this.setButtonLoading(o,!0),r.classList.remove("show");const a=await ll(t,i,s);a.success?console.log("Login exitoso"):a.needsVerification?(r.textContent=a.error,r.classList.add("show"),this.showView("verify")):(r.textContent=a.error,r.classList.add("show")),this.setButtonLoading(o,!1)}async handleRegister(e){e.preventDefault();const t=document.getElementById("register-name").value,i=document.getElementById("register-lastname").value,s=document.getElementById("register-email").value,r=document.getElementById("register-password").value,o=document.getElementById("register-error"),a=document.getElementById("register-submit");let c=!1;if(as(t)||(this.showInputError("register-name","Ingresa tu nombre"),c=!0),as(i)||(this.showInputError("register-lastname","Ingresa tu apellido"),c=!0),vn(s)||(this.showInputError("register-email","Ingresa un correo válido"),c=!0),os(r)||(this.showInputError("register-password","Mínimo 6 caracteres"),c=!0),c)return;this.setButtonLoading(a,!0),o.classList.remove("show");const l=await cl(s,r,{name:t,lastName:i});l.success?console.log("Registro exitoso, esperando verificación"):(o.textContent=l.error,o.classList.add("show")),this.setButtonLoading(a,!1)}async handleGoogleLogin(){const e=await hl();if(!e.success){const t=document.getElementById(this.currentView==="register"?"register-error":"login-error");t&&(t.textContent=e.error,t.classList.add("show"))}}async handleForgotPassword(e){e.preventDefault();const t=document.getElementById("forgot-email").value,i=document.getElementById("forgot-error"),s=document.getElementById("forgot-success"),r=document.getElementById("forgot-submit");if(!vn(t)){this.showInputError("forgot-email","Ingresa un correo válido");return}this.setButtonLoading(r,!0),i.classList.remove("show"),s.classList.remove("show");const o=await fl(t);o.success?(s.textContent=o.message,s.classList.add("show")):(i.textContent=o.error,i.classList.add("show")),this.setButtonLoading(r,!1)}async handleResendVerification(){const e=document.getElementById("resend-verification-btn"),t=document.getElementById("verify-message");this.setButtonLoading(e,!0);const i=await ul();i.success?(t.innerHTML=`✅ ${i.message}`,t.style.color="#16a34a"):(t.innerHTML=`❌ ${i.error}`,t.style.color="#dc2626"),this.setButtonLoading(e,!1),setTimeout(()=>{t.innerHTML="Hemos enviado un enlace de verificación a tu correo. Revisa tu bandeja de entrada.",t.style.color=""},5e3)}async handleCheckVerification(){const e=document.getElementById("check-verification-btn"),t=document.getElementById("verify-message");this.setButtonLoading(e,!0);const i=await dl();i.success&&i.verified?(t.innerHTML="✅ ¡Correo verificado! Entrando...",t.style.color="#16a34a",setTimeout(()=>window.location.reload(),1e3)):(t.innerHTML="⚠️ Tu correo aún no ha sido verificado.",t.style.color="#f59e0b",setTimeout(()=>{t.innerHTML="Hemos enviado un enlace de verificación a tu correo.",t.style.color=""},5e3)),this.setButtonLoading(e,!1)}togglePassword(e){const t=document.getElementById(e),i=t==null?void 0:t.parentElement.querySelector(".toggle-password span");t&&i&&(t.type==="password"?(t.type="text",i.textContent="visibility_off"):(t.type="password",i.textContent="visibility"))}showInputError(e,t){const i=document.getElementById(`${e}-error`),s=document.getElementById(e);i&&(i.textContent=t,i.classList.add("show")),s&&(s.classList.add("error"),s.addEventListener("input",()=>{i==null||i.classList.remove("show"),s.classList.remove("error")},{once:!0}))}setButtonLoading(e,t){if(!e)return;const i=e.querySelector(".button-text"),s=e.querySelector(".button-loader");e.disabled=t,i&&(i.style.display=t?"none":"block"),s&&(s.style.display=t?"block":"none")}}class zo{constructor(e){this.user=e,this.db=cr(),this.deviceTimers={},this.listeners=[],this.pendingTimeouts=[]}async loadSites(){const e=D(this.db,"US/"+this.user.uid+"/M");try{const t=await ne(e);if(t.exists()){const i=t.val(),s=[];for(const r of Object.keys(i)){const o=D(this.db,"P/"+r+"/L"),a=await ne(o),c=a.exists()&&(a.val()===1||a.val()===11),l={1:"door_open",2:"fingerprint",3:"location_city",4:"garage_door",5:"garage_door"},u={1:"blue",2:"green",3:"red",4:"purple",5:"orange"},d={1:"Puerta Motorizada",2:"Control de Acceso",3:"Alarma Comunitaria",4:"Alarma",5:"Alarma DSC"};s.push({serial:r,name:i[r].N||"Sin nombre",type:i[r].T||0,typeName:d[i[r].T]||"Desconocido",icon:l[i[r].T]||"devices",color:u[i[r].T]||"blue",role:i[r].U||"INV",status:c?"online":"offline"})}return localStorage.setItem("sites_"+this.user.uid,JSON.stringify(s)),s}}catch{const i=localStorage.getItem("sites_"+this.user.uid);if(i)return JSON.parse(i)}return[]}renderSites(e){const t=document.getElementById("sites-list");if(t){if(e.length===0){t.innerHTML='<div class="empty-state"><span class="material-symbols-outlined">home_work</span><h3>No tienes sitios</h3><p>Agrega tu primer sitio para empezar</p></div>';return}t.innerHTML=e.map(i=>`
     <div class="site-card" data-serial="${i.serial}" data-type="${i.type}" data-search="${i.name} ${i.serial}">
        ...
        </div><span class="material-symbols-outlined arrow-icon">chevron_right</span></div>`).join("")}}async addSite(e,t,i,s,r){try{return await Ve(D(this.db,"US/"+this.user.uid+"/M/"+e),{C:s||"1234",N:t,L:i||"Sin ubicación",U:r||"ADM"}),!0}catch{return!1}}setupSearch(){var e;(e=document.getElementById("search-input"))==null||e.addEventListener("input",t=>{const i=t.target.value.toLowerCase();document.querySelectorAll(".site-card").forEach(s=>{s.style.display=s.dataset.search.toLowerCase().includes(i)?"flex":"none"})})}async pingAllModules(){const e=D(this.db,"US/"+this.user.uid+"/M");try{const t=await ne(e);if(t.exists()){const i=t.val();for(const s of Object.keys(i))await this.pingDevice(s)}}catch(t){console.error("Error al hacer ping:",t)}}async pingDevice(e){try{const t=D(this.db,`M/${e}/X/D/L`),i=await ne(t),s=i.exists()?i.val():0,r=s===11?1:11;await Ve(t,r),await Ve(D(this.db,`P/${e}`),{L:0}),console.log(`🩺 Ping a ${e}: X/D/L ${s} → ${r}, P/L=0`)}catch(t){console.error("Error en ping:",t)}}listenModulesStatus(){ne(D(this.db,"US/"+this.user.uid+"/M")).then(e=>{if(e.exists())for(const t of Object.keys(e.val())){const i=D(this.db,"P/"+t+"/L");let s=!0;const r=Oo(i,o=>{const a=o.exists()&&(o.val()===1||o.val()===11);if(!a&&s){const c=setTimeout(()=>{ne(i).then(l=>{!l.exists()||l.val()!==1&&l.val()!==11?this.updateSiteStatus(t,!1):this.updateSiteStatus(t,!0)})},3e4);this.pendingTimeouts.push(c)}else a&&this.updateSiteStatus(t,!0);s=a});this.listeners.push(r)}})}updateSiteStatus(e,t){const i=document.querySelector(`.site-card[data-serial="${e}"]`);if(!i)return;const s=i.querySelector(".status-dot"),r=i.querySelector(".status-text"),o=i.querySelector(".site-icon");s&&(s.className="status-dot "+(t?"online":"offline")),r&&(r.textContent=t?"En línea":"Sin conexión"),o&&(o.className="site-icon "+(t?"online":"offline"))}startHealthCheck(e){this.stopHealthCheck(),ne(D(this.db,"US/"+e+"/M")).then(t=>{if(t.exists())for(const i of Object.keys(t.val()))Oo(D(this.db,"P/"+i+"/L"),s=>{s.exists()&&s.val()===1?this.deviceTimers[i]||(this.deviceTimers[i]=setInterval(()=>this.pingDevice(i),6e4)):this.deviceTimers[i]&&(clearInterval(this.deviceTimers[i]),this.deviceTimers[i]=null)})})}stopHealthCheck(){this.deviceTimers&&(Object.values(this.deviceTimers).forEach(e=>clearInterval(e)),this.deviceTimers={})}stopAllListeners(){this.stopHealthCheck(),this.listeners&&(this.listeners.forEach(e=>{typeof e=="function"&&e()}),this.listeners=[]),this.pendingTimeouts&&(this.pendingTimeouts.forEach(e=>clearTimeout(e)),this.pendingTimeouts=[]),console.log("🔇 Dashboard detenido")}async disconnectAllModules(){const e=await ne(D(this.db,"US/"+this.user.uid+"/M"));if(e.exists())for(const t of Object.keys(e.val()))await Ve(D(this.db,"P/"+t),{L:0})}async logout(){await this.disconnectAllModules(),await jn()}}function ny(n,e="error"){const t=document.getElementById("global-toast");t&&t.remove();const i=document.createElement("div");i.id="global-toast",i.style.cssText=`
