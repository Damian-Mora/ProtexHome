import{D as ve,H as be}from"./historyController-DY3G_hr2.js";import{e as Y,b as fe,g as ge,r as m,o as I,f as L,s as p,u as he}from"./index-DcGEaaWs.js";const Ee=`<!-- Vista Alarma DSC -->\r
\r
...
\r
</div>`;async function ze(J,i,K){var O,_,H,j,V,U,q,F,W,G,Q;const X=document.getElementById("main-content");X.innerHTML=Ee;const w=new ve(J,i),f=await w.loadDeviceData();if(!f){alert("Dispositivo no encontrado"),Y();return}fe(i,"device");const k=await w.getUserRole(),ee=k==="PRO"||k==="ADM";document.getElementById("device-name").textContent=f.name,document.getElementById("info-serial").textContent=f.serial,document.getElementById("edit-device-name").value=f.name,document.getElementById("info-role").textContent=k;const N=e=>{const t=document.getElementById("device-status-badge"),n=t==null?void 0:t.querySelector(".status-dot"),a=t==null?void 0:t.querySelector("span:last-child");n&&(n.className=`status-dot ${e==="online"?"online":"offline"}`),a&&(a.textContent=e==="online"?"En línea":"Sin conexión")};N(f.status);const h=[],ne=w.listenOnlineStatus(N);h.push(ne);const E=new be(i),te=await E.loadHistory(20),P=ee;E.renderHistory(te,"history-list",P);const ae=E.listenNewEvents(e=>{E.renderHistory(e,"history-list",P)});h.push(ae);const l=ge();let o=1,x=[];const u=[];let B=!1;function $(){const e=document.getElementById("partition-select"),t=document.getElementById("partition-selector-container");e.innerHTML="",u.forEach(n=>{const a=document.createElement("option");a.value=n,a.textContent=`Partición ${n}`,n===o&&(a.selected=!0),e.appendChild(a)}),u.length<=1?(t.style.display="none",o=u[0]||1):(t.style.display="flex",u.includes(o)||(o=u[0],e.value=o)),M(),S(),B||(B=!0,setTimeout(()=>{var a;const n=document.getElementById("dsc-loading-overlay");n&&(n.style.opacity="0",setTimeout(()=>n.remove(),400)),(a=document.getElementById("dsc-content"))==null||a.classList.add("ready")},1500))}function M(){const e=document.getElementById("partition-name");e&&(e.textContent=`Partición ${o}`)}function S(){x.forEach(n=>{typeof n=="function"&&n()}),x=[];const e=m(l,`P/${i}/E${o}`),t=I(e,n=>{const a=n.exists()?Number(n.val()):0;ie(a)});x.push(t)}const se=m(l,`P/${i}`),oe=I(se,e=>{if(!e.exists()){u.length=0,$();return}const t=e.val();u.length=0;for(let n=1;n<=8;n++)t[`P${n}`]===2&&u.push(n);$()});h.push(oe),(O=document.getElementById("partition-select"))==null||O.addEventListener("change",e=>{o=Number(e.target.value),M(),S(),A()});function ie(e){const t=document.getElementById("partition-state"),n=document.getElementById("partition-led"),a=document.getElementById("btn-arm-away"),s=document.getElementById("btn-arm-home"),r=document.getElementById("btn-disarm"),d={0:{text:"Desconocido",led:"dsc-led disarmed"},1:{text:"Listo para armar",led:"dsc-led ready"},2:{text:"Listo con zonas abiertas",led:"dsc-led not-ready"},3:{text:"No listo",led:"dsc-led not-ready"},4:{text:"Armado en Casa",led:"dsc-led armed-home"},5:{text:"Armado Ausente",led:"dsc-led armed-away"},6:{text:"Armado sin entrada",led:"dsc-led armed-away"},9:{text:"Armado sin entrada",led:"dsc-led armed-away"},22:{text:"Armado sin entrada",led:"dsc-led armed-away"},7:{text:"Falla al armar",led:"dsc-led not-ready"},8:{text:"Tiempo de salida",led:"dsc-led armed-away"},11:{text:"Salida rápida",led:"dsc-led armed-away"},12:{text:"Retardo de entrada",led:"dsc-led armed-home"},13:{text:"Retardo después de alarma",led:"dsc-led armed-home"},17:{text:"Área en alarma",led:"dsc-led not-ready"},18:{text:"Armado con zonas anuladas",led:"dsc-led armed-away"},21:{text:"Armado con zonas anuladas",led:"dsc-led armed-away"},25:{text:"Memoria de alarma",led:"dsc-led disarmed"}},c=d[e]||d[0];t&&(t.textContent=c.text),n&&(n.className=`dsc-led ${c.led}`),re(e,a,s,r)}function re(e,t,n,a){if(t.disabled=!1,n.disabled=!1,a.disabled=!1,[0,7,8,11].includes(e)){e===8||e===11?(t.classList.add("blink"),n.classList.add("blink")):(t.classList.remove("blink"),n.classList.remove("blink"));return}[1,2,3,25].includes(e)?(t.disabled=!1,n.disabled=!1,a.disabled=!0):([4,12,13].includes(e)||[5,6,9,22,18,21].includes(e)||e===17)&&(t.disabled=!0,n.disabled=!0,a.disabled=!1),[8,11].includes(e)||(t.classList.remove("blink"),n.classList.remove("blink"))}let y=null,v=null,Z={},D={},z=null,C="";function le(){y&&(y(),y=null),v&&(v(),v=null);const e=m(l,`M/${i}/W/Z`);y=I(e,n=>{Z=n.exists()?n.val():{},A()});const t=m(l,`M/${i}/W/NZ`);v=I(t,n=>{D=n.exists()?n.val():{},A()})}function A(){const e=document.getElementById("zones-list");if(!e)return;const n=Object.entries(Z||{}).filter(([a,s])=>s.A===o&&s.E!==void 0);if(n.length===0){e.innerHTML='<p style="color:var(--text-light);text-align:center;">Sin zonas configuradas para esta partición</p>';return}n.sort((a,s)=>Number(a[0])-Number(s[0])),e.innerHTML=n.map(([a,s])=>{const r=D[a]||{},d=r.A===o&&r.N?r.N:`Zona ${a}`,c=s.E===1,b=s.B===1,me=b?"Anulada":c?"Abierta":"Cerrada",ue=c?"door_open":"door_front",pe=b?"Quitar anulación":"Anular zona",ye=String(a).padStart(2,"0");return`
          <div class="zone-item">
            <div class="zone-info">
        ...
        `}).join(""),e.querySelectorAll(".btn-bypass").forEach(a=>{a.addEventListener("click",async()=>{const s=a.dataset.zone,d=Number(a.dataset.currentBypass)===1?0:1;await L(m(l,`M/${i}/W/Z/${s}/B`),d),p(d===1?"✅ Zona anulada":"✅ Zona restaurada","success")})}),window.editZone=de}function de(e){if(!e)return;z=e;const t=document.getElementById("edit-zone-modal"),n=document.getElementById("edit-zone-name-input"),a=document.getElementById("save-zone-name-btn"),s=D[e]||{};C=s.A===o&&s.N?s.N:"",n.value=C,a.style.display="none";const r=()=>{const c=n.value.trim(),b=c!==C&&c.length>0;a.style.display=b?"flex":"none"};n.addEventListener("input",r);const d=()=>{n.removeEventListener("input",r)};t._cleanupListener=d,t.style.display="flex",n.focus(),n.select(),setTimeout(()=>{r()},50)}function g(){const e=document.getElementById("edit-zone-modal");e._cleanupListener&&(e._cleanupListener(),e._cleanupListener=null),e.style.display="none",z=null,document.getElementById("save-zone-name-btn").style.display="none"}async function T(){if(!z)return;const t=document.getElementById("edit-zone-name-input").value.trim();if(!t){p("⚠️ El nombre no puede estar vacío","error");return}if(t===C){p("ℹ️ El nombre no ha cambiado","info"),g();return}try{await he(m(l,`M/${i}/W/NZ/${z}`),{A:o,N:t}),p("✅ Nombre actualizado correctamente","success"),g()}catch(n){console.error("Error al guardar nombre:",n),p("❌ Error al guardar el nombre","error")}}(_=document.getElementById("save-zone-name-btn"))==null||_.addEventListener("click",T),(H=document.getElementById("close-zone-modal"))==null||H.addEventListener("click",g),(j=document.getElementById("edit-zone-modal"))==null||j.addEventListener("click",e=>{e.target===e.currentTarget&&g()}),(V=document.getElementById("edit-zone-name-input"))==null||V.addEventListener("keydown",e=>{e.key==="Enter"&&(e.preventDefault(),document.getElementById("save-zone-name-btn").style.display!=="none"&&T()),e.key==="Escape"&&g()});function R(e){document.getElementById("tab-zonas").classList.toggle("active",e==="zonas"),document.getElementById("tab-historial").classList.toggle("active",e==="historial"),document.getElementById("panel-zonas").style.display=e==="zonas"?"block":"none",document.getElementById("panel-historial").style.display=e==="historial"?"block":"none"}(U=document.getElementById("tab-zonas"))==null||U.addEventListener("click",()=>R("zonas")),(q=document.getElementById("tab-historial"))==null||q.addEventListener("click",()=>R("historial")),(F=document.getElementById("btn-arm-away"))==null||F.addEventListener("click",async()=>{await L(m(l,`M/${i}/DSC/P${o}/CMD`),1),p("🔒 Armado ausente","success")}),(W=document.getElementById("btn-arm-home"))==null||W.addEventListener("click",async()=>{await L(m(l,`M/${i}/DSC/P${o}/CMD`),2),p("🏠 Armado en casa","success")}),(G=document.getElementById("btn-disarm"))==null||G.addEventListener("click",async()=>{await L(m(l,`M/${i}/DSC/P${o}/CMD`),0),p("🔓 Desarmado","success")});const ce=()=>{h.forEach(e=>{typeof e=="function"&&e()}),x.forEach(e=>{typeof e=="function"&&e()}),y&&(y(),y=null),v&&(v(),v=null),Y()};(Q=document.getElementById("back-to-dashboard"))==null||Q.addEventListener("click",()=>{ce(),K()}),setTimeout(()=>{var t;const e=document.getElementById("dsc-loading-overlay");e&&!B&&(B=!0,e.style.opacity="0",setTimeout(()=>e.remove(),300),(t=document.getElementById("dsc-content"))==null||t.classList.add("ready"),console.warn("⚠️ Overlay ocultado por timeout de seguridad"))},5e3),le()}export{ze as openAlarmDscView};
