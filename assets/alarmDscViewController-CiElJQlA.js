import{D as fe}from"./deviceController-EqaCZu_2.js";import{f as ee,c as be,g as ye,r as p,o as $,b as k,s as b,u as ve}from"./index-BvtLhYp5.js";const ge=`<!-- Vista Alarma DSC -->\r
\r
...
\r
        ...
        `}).join("")}me();function S(e){document.getElementById("tab-zonas").classList.toggle("active",e==="zonas"),document.getElementById("tab-historial").classList.toggle("active",e==="historial"),document.getElementById("panel-zonas").classList.toggle("active",e==="zonas"),document.getElementById("panel-historial").classList.toggle("active",e==="historial"),e==="historial"&&P()}setTimeout(()=>{S("historial")},100),(G=document.getElementById("tab-zonas"))==null||G.addEventListener("click",()=>S("zonas")),(Q=document.getElementById("tab-historial"))==null||Q.addEventListener("click",()=>S("historial")),(Y=document.getElementById("btn-arm-away"))==null||Y.addEventListener("click",async()=>{await k(p(u,`M/${d}/DSC/P${l}/CMD`),1),b("🔒 Armado ausente","success")}),(J=document.getElementById("btn-arm-home"))==null||J.addEventListener("click",async()=>{await k(p(u,`M/${d}/DSC/P${l}/CMD`),2),b("🏠 Armado en casa","success")}),(K=document.getElementById("btn-disarm"))==null||K.addEventListener("click",async()=>{await k(p(u,`M/${d}/DSC/P${l}/CMD`),0),b("🔓 Desarmado","success")});const pe=()=>{D.forEach(e=>{typeof e=="function"&&e()}),L.forEach(e=>{typeof e=="function"&&e()}),y&&(y(),y=null),v&&(v(),v=null),g&&(g(),g=null),ee()};(X=document.getElementById("back-to-dashboard"))==null||X.addEventListener("click",()=>{pe(),te()}),setTimeout(()=>{var t;const e=document.getElementById("dsc-loading-overlay");e&&!z&&(z=!0,e.style.opacity="0",setTimeout(()=>e.remove(),300),(t=document.getElementById("dsc-content"))==null||t.classList.add("ready"),console.warn("⚠️ Overlay ocultado por timeout de seguridad"))},5e3),ce()}export{Ee as openAlarmDscView};
