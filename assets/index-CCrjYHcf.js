const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./doorViewController-DsdbJcmD.js","./deviceController-RsQCemCs.js","./alarmDscViewController-bzt0Lql1.js"])))=>i.map(i=>d[i]);
(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();const tu="modulepreload",nu=function(n,e){return new URL(n,e).href},Rr={},fn=function(e,t,i){let s=Promise.resolve();if(t&&t.length>0){const o=document.getElementsByTagName("link"),a=document.querySelector("meta[property=csp-nonce]"),c=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));s=Promise.allSettled(t.map(l=>{if(l=nu(l,i),l in Rr)return;Rr[l]=!0;const u=l.endsWith(".css"),d=u?'[rel="stylesheet"]':"";if(!!i)for(let g=o.length-1;g>=0;g--){const v=o[g];if(v.href===l&&(!u||v.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${l}"]${d}`))return;const f=document.createElement("link");if(f.rel=u?"stylesheet":tu,u||(f.as="script"),f.crossOrigin="",f.href=l,c&&f.setAttribute("nonce",c),document.head.appendChild(f),u)return new Promise((g,v)=>{f.addEventListener("load",g),f.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return s.then(o=>{for(const a of o||[])a.status==="rejected"&&r(a.reason);return e().catch(r)})},iu=`<!-- Login -->\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const p=function(n,e){if(!n)throw yt(e)},yt=function(n){return new Error("Firebase Database ("+na.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const An=new vs("@firebase/auth");function jd(n,...e){An.logLevel<=I.WARN&&An.warn(`Auth (${Et}): ${n}`,...e)}function _n(n,...e){An.logLevel<=I.ERROR&&An.error(`Auth (${Et}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tn{constructor(e,t){this.shortDelay=e,this.longDelay=t,_e(t>e,"Short delay should be less than long delay!"),this.isMobile=_s()||ua()}get(){return zd()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jd=new tn(3e4,6e4);function we(n,e){return n.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:n.tenantId}):e}async function Ee(n,e,t,i,s={}){return ba(n,s,async()=>{let r={},o={};i&&(e==="GET"?o=i:r={body:JSON.stringify(i)});const a=wt(Object.assign({key:n.config.apiKey},o)).slice(1),c=await n._getAdditionalHeaders();c["Content-Type"]="application/json",n.languageCode&&(c["X-Firebase-Locale"]=n.languageCode);const l=Object.assign({method:e,headers:c},r);return wu()||(l.referrerPolicy="no-referrer"),Ea.fetch()(Ia(n,n.config.apiHost,t,a),l)})}async function ba(n,e,t){n._canInitEmulator=!1;const i=Object.assign(Object.assign({},Yd),e);try{const s=new Xd(n),r=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw pn(n,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const a=r.ok?o.errorMessage:o.error.message,[c,l]=a.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw pn(n,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw pn(n,"email-already-in-use",o);if(c==="USER_DISABLED")throw pn(n,"user-disabled",o);const u=i[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(l)throw Es(n,u,l);z(n,u)}}catch(s){if(s instanceof re)throw s;z(n,"network-request-failed",{message:String(s)})}}async function nn(n,e,t,i,s={}){const r=await Ee(n,e,t,i,s);return"mfaPendingCredential"in r&&z(n,"multi-factor-auth-required",{_serverResponse:r}),r}function Ia(n,e,t,i){const s=`${e}${t}?${i}`;return n.config.emulator?Is(n.config,s):`${n.config.apiScheme}://${s}`}function Qd(n){switch(n){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class Xd{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,i)=>{this.timer=setTimeout(()=>i(Z(this.auth,"network-request-failed")),Jd.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function pn(n,e,t){const i={appName:n.name};t.email&&(i.email=t.email),t.phoneNumber&&(i.phoneNumber=t.phoneNumber);const s=Z(n,e,i);return s.customData._tokenResponse=t,s}function Hr(n){return n!==void 0&&n.enterprise!==void 0}class Zd{constructor(e){if(this.siteKey="",this.recaptchaEnforcementState=[],e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.recaptchaEnforcementState=e.recaptchaEnforcementState}getProviderEnforcementState(e){if(!this.recaptchaEnforcementState||this.recaptchaEnforcementState.length===0)return null;for(const t of this.recaptchaEnforcementState)if(t.provider&&t.provider===e)return Qd(t.enforcementState);return null}isProviderEnabled(e){return this.getProviderEnforcementState(e)==="ENFORCE"||this.getProviderEnforcementState(e)==="AUDIT"}}async function eh(n,e){return Ee(n,"GET","/v2/recaptchaConfig",we(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lt(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function nh(n,e=!1){const t=A(n),i=await t.getIdToken(e),s=Ts(i);m(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const r=typeof s.firebase=="object"?s.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:s,token:i,authTime:Lt(Si(s.auth_time)),issuedAtTime:Lt(Si(s.iat)),expirationTime:Lt(Si(s.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function Si(n){return Number(n)*1e3}function Ts(n){const[e,t,i]=n.split(".");if(e===void 0||t===void 0||i===void 0)return _n("JWT malformed, contained fewer than 3 sections"),null;try{const s=Tn(t);return s?JSON.parse(s):(_n("Failed to decode base64 JWT payload"),null)}catch(s){return _n("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function jr(n){const e=Ts(n);return m(e,"internal-error"),m(typeof e.exp<"u","internal-error"),m(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ah(n,e){const t=await ba(n,{},async()=>{const i=wt({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:r}=n.config,o=Ia(n,s,"/v1/token",`key=${r}`),a=await n._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",Ea.fetch()(o,{method:"POST",headers:a,body:i})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function ch(n,e){return Ee(n,"POST","/v2/accounts:revokeToken",we(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ot{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){m(e.idToken,"internal-error"),m(typeof e.idToken<"u","internal-error"),m(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):jr(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){m(e.length!==0,"internal-error");const t=jr(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(m(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:i,refreshToken:s,expiresIn:r}=await ah(e,t);this.updateTokensAndExpiration(i,s,Number(r))}updateTokensAndExpiration(e,t,i){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+i*1e3}static fromJSON(e,t){const{refreshToken:i,accessToken:s,expirationTime:r}=t,o=new ot;return i&&(m(typeof i=="string","internal-error",{appName:e}),o.refreshToken=i),s&&(m(typeof s=="string","internal-error",{appName:e}),o.accessToken=s),r&&(m(typeof r=="number","internal-error",{appName:e}),o.expirationTime=r),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new ot,this.toJSON())}_performRefresh(){return le("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vn(n,e,t){return`firebase:${n}:${e}:${t}`}class at{constructor(e,t,i){this.persistence=e,this.auth=t,this.userKey=i;const{config:s,name:r}=this.auth;this.fullUserKey=vn(this.userKey,s.apiKey,r),this.fullPersistenceKey=vn("persistence",s.apiKey,r),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?ue._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,i="authUser"){if(!t.length)return new at(de(Gr),e,i);const s=(await Promise.all(t.map(async l=>{if(await l._isAvailable())return l}))).filter(l=>l);let r=s[0]||de(Gr);const o=vn(i,e.config.apiKey,e.name);let a=null;for(const l of t)try{const u=await l._get(o);if(u){const d=ue._fromJSON(e,u);l!==r&&(a=d),r=l;break}}catch{}const c=s.filter(l=>l._shouldAllowMigration);return!r._shouldAllowMigration||!c.length?new at(r,e,i):(r=c[0],a&&await r._set(o,a.toJSON()),await Promise.all(t.map(async l=>{if(l!==r)try{await l._remove(o)}catch{}})),new at(r,e,i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ma(n,e=[]){let t;switch(n){case"Browser":t=zr($());break;case"Worker":t=`${zr($())}-${n}`;break;default:t=n}const i=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Et}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ct(n,e){return nn(n,"POST","/v1/accounts:signInWithIdp",we(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mh(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function xh(n){const e=Ot(Dt(n)).link,t=e?Ot(Dt(e)).deep_link_id:null,i=Ot(Dt(n)).deep_link_id;return(i?Ot(Dt(i)).link:null)||i||t||e||n}class ks{constructor(e){var t,i,s,r,o,a;const c=Ot(Dt(e)),l=(t=c.apiKey)!==null&&t!==void 0?t:null,u=(i=c.oobCode)!==null&&i!==void 0?i:null,d=Mh((s=c.mode)!==null&&s!==void 0?s:null);m(l&&u&&d,"argument-error"),this.apiKey=l,this.operation=d,this.code=u,this.continueUrl=(r=c.continueUrl)!==null&&r!==void 0?r:null,this.languageCode=(o=c.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=c.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const t=xh(e);try{return new ks(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bt{constructor(){this.providerId=bt.PROVIDER_ID}static credential(e,t){return Ht._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const i=ks.parseLink(t);return m(i,"argument-error"),Ht._fromEmailAndCode(e,i.code,i.tenantId)}}bt.PROVIDER_ID="password";bt.EMAIL_PASSWORD_SIGN_IN_METHOD="password";bt.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sn extends As{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wa(n){const e=be(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function $h(n,e,t){const i=be(n),s={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};t&&$a(i,s,t),await Rn(i,s,"getOobCode",Ph)}async function Wh(n,e,t){if(Q(n.app))return Promise.reject(pe(n));const i=be(n),o=await Rn(i,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Fh).catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&Wa(n),c}),a=await Ge._fromIdTokenResponse(i,"signIn",o);return await i._updateCurrentUser(a.user),a}function Hh(n,e,t){return Q(n.app)?Promise.reject(pe(n)):Vh(A(n),bt.credential(e,t)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&Wa(n),i})}async function Ha(n,e){const t=A(n),s={requestType:"VERIFY_EMAIL",idToken:await n.getIdToken()};e&&$a(t.auth,s,e);const{email:r}=await Rh(t.auth,s);r!==n.email&&await n.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ja(n,e){return A(n).setPersistence(e)}function jh(n,e,t,i){return A(n).onIdTokenChanged(e,t,i)}function qh(n,e,t){return A(n).beforeAuthStateChanged(e,t)}function Gh(n,e,t,i){return A(n).onAuthStateChanged(e,t,i)}function Ns(n){return A(n).signOut()}async function zh(n){return A(n).delete()}const On="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Of=new tn(5e3,15e3),Df="__/auth/iframe",Lf="emulator/auth/iframe",Mf={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},xf=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Ff(n){const e=n.config;m(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?Is(e,Lf):`https://${n.config.authDomain}/${Df}`,i={apiKey:e.apiKey,appName:n.name,v:Et},s=xf.get(n.config.apiHost);s&&(i.eid=s);const r=n._getFrameworks();return r.length&&(i.fw=r.join(",")),`${t}?${wt(i).slice(1)}`}async function Uf(n){const e=await Pf(n),t=ie().gapi;return m(t,n,"internal-error"),e.open({where:document.body,url:Ff(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Mf,dontclear:!0},i=>new Promise(async(s,r)=>{await i.restyle({setHideOnLeave:!1});const o=Z(n,"network-request-failed"),a=ie().setTimeout(()=>{r(o)},Of.get());function c(){ie().clearTimeout(a),s(i)}i.ping(c).then(c,()=>{r(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gf="__/auth/handler",zf="emulator/auth/handler",Kf=encodeURIComponent("fac");async function io(n,e,t,i,s,r){m(n.config.authDomain,n,"auth-domain-config-required"),m(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:i,v:Et,eventId:s};if(e instanceof As){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",$i(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[u,d]of Object.entries({}))o[u]=d}if(e instanceof sn){const u=e.getScopes().filter(d=>d!=="");u.length>0&&(o.scopes=u.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const u of Object.keys(a))a[u]===void 0&&delete a[u];const c=await n._getAppCheckToken(),l=c?`#${Kf}=${encodeURIComponent(c)}`:"";return`${Yf(n)}?${wt(a).slice(1)}${l}`}function Yf({config:n}){return n.emulator?Is(n,zf):`https://${n.authDomain}/${Gf}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lt=new vs("@firebase/database"),lp=function(){let n=1;return function(){return n++}}(),sc=function(n){const e=Lu(n),t=new Ru;t.update(e);const i=t.digest();return gs.encodeByteArray(i)},on=function(...n){let e="";for(let t=0;t<n.length;t++){const i=n[t];Array.isArray(i)||i&&typeof i=="object"&&typeof i.length=="number"?e+=on.apply(null,i):typeof i=="object"?e+=D(i):e+=i,e+=" "}return e};let Mt=null,uo=!0;const up=function(n,e){p(!0,"Can't turn on custom loggers persistently."),lt.logLevel=I.VERBOSE,Mt=lt.log.bind(lt)},x=function(...n){if(uo===!0&&(uo=!1,Mt===null&&cp.get("logging_enabled")===!0&&up()),Mt){const e=on.apply(null,n);Mt(e)}},an=function(n){return function(...e){x(n,...e)}},Ji=function(...n){const e="FIREBASE INTERNAL ERROR: "+on(...n);lt.error(e)},ve=function(...n){const e=`FIREBASE FATAL ERROR: ${on(...n)}`;throw lt.error(e),new Error(e)},V=function(...n){const e="FIREBASE WARNING: "+on(...n);lt.warn(e)},dp=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&V("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},Ls=function(n){return typeof n=="number"&&(n!==n||n===Number.POSITIVE_INFINITY||n===Number.NEGATIVE_INFINITY)},hp=function(n){if(document.readyState==="complete")n();else{let e=!1;const t=function(){if(!document.body){setTimeout(t,Math.floor(10));return}e||(e=!0,n())};document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&t()}),window.attachEvent("onload",t))}},ft="[MIN_NAME]",ze="[MAX_NAME]",tt=function(n,e){if(n===e)return 0;if(n===ft||e===ze)return-1;if(e===ft||n===ze)return 1;{const t=ho(n),i=ho(e);return t!==null?i!==null?t-i===0?n.length-e.length:t-i:-1:i!==null?1:n<e?-1:1}},fp=function(n,e){return n===e?0:n<e?-1:1},kt=function(n,e){if(e&&n in e)return e[n];throw new Error("Missing required key ("+n+") in object: "+D(e))},Ms=function(n){if(typeof n!="object"||n===null)return D(n);const e=[];for(const i in n)e.push(i);e.sort();let t="{";for(let i=0;i<e.length;i++)i!==0&&(t+=","),t+=D(e[i]),t+=":",t+=Ms(n[e[i]]);return t+="}",t},rc=function(n,e){const t=n.length;if(t<=e)return[n];const i=[];for(let s=0;s<t;s+=e)s+e>t?i.push(n.substring(s,t)):i.push(n.substring(s,s+e));return i};function F(n,e){for(const t in n)n.hasOwnProperty(t)&&e(t,n[t])}const oc=function(n){p(!Ls(n),"Invalid JSON number");const e=11,t=52,i=(1<<e-1)-1;let s,r,o,a,c;n===0?(r=0,o=0,s=1/n===-1/0?1:0):(s=n<0,n=Math.abs(n),n>=Math.pow(2,1-i)?(a=Math.min(Math.floor(Math.log(n)/Math.LN2),i),r=a+i,o=Math.round(n*Math.pow(2,t-a)-Math.pow(2,t))):(r=0,o=Math.round(n/Math.pow(2,1-i-t))));const l=[];for(c=t;c;c-=1)l.push(o%2?1:0),o=Math.floor(o/2);for(c=e;c;c-=1)l.push(r%2?1:0),r=Math.floor(r/2);l.push(s?1:0),l.reverse();const u=l.join("");let d="";for(c=0;c<64;c+=8){let h=parseInt(u.substr(c,8),2).toString(16);h.length===1&&(h="0"+h),d=d+h}return d.toLowerCase()},pp=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},gp=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function mp(n,e){let t="Unknown Error";n==="too_big"?t="The data requested exceeds the maximum size that can be accessed with a single request.":n==="permission_denied"?t="Client doesn't have permission to access the desired data.":n==="unavailable"&&(t="The service is unavailable");const i=new Error(n+" at "+e._path.toString()+": "+t);return i.code=n.toUpperCase(),i}const _p=new RegExp("^-?(0*)\\d{1,10}$"),vp=-2147483648,yp=2147483647,ho=function(n){if(_p.test(n)){const e=Number(n);if(e>=vp&&e<=yp)return e}return null},It=function(n){try{n()}catch(e){setTimeout(()=>{const t=e.stack||"";throw V("Exception was thrown by user callback.",t),e},Math.floor(0))}},wp=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},xt=function(n,e){const t=setTimeout(n,e);return typeof t=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(t):typeof t=="object"&&t.unref&&t.unref(),t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sp{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const i=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let s=0;s<i.length;++s)i[s]&&It(()=>{this.onMessage_(i[s])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mn extends Tc{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!_s()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new Mn}getInitialEvent(e){return p(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class si{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const i=new w(ft,e),s=new w(ft,t);return this.compare(i,s)!==0}minPost(){return w.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let gn;class kc extends si{static get __EMPTY_NODE(){return gn}static set __EMPTY_NODE(e){gn=e}compare(e,t){return tt(e.name,t.name)}isDefinedOn(e){throw yt("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return w.MIN}maxPost(){return new w(ze,gn)}makePost(e,t){return p(typeof e=="string","KeyIndex indexValue must always be a string."),new w(e,gn)}toString(){return".key"}}const ut=new kc;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Pi;const it={};class he{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return p(it&&P,"ChildrenNode.ts has not been loaded"),Pi=Pi||new he({".priority":it},{".priority":P}),Pi}get(e){const t=ht(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof W?t:null}hasIndex(e){return oe(this.indexSet_,e.toString())}addIndex(e,t){p(e!==ut,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=t.getIterator(w.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=xn(i,e.getCompare()):a=it;const c=e.toString(),l=Object.assign({},this.indexSet_);l[c]=e;const u=Object.assign({},this.indexes_);return u[c]=a,new he(u,l)}addToIndexes(e,t){const i=Cn(this.indexes_,(s,r)=>{const o=ht(this.indexSet_,r);if(p(o,"Missing index implementation for "+r),s===it)if(o.isDefinedOn(e.node)){const a=[],c=t.getIterator(w.Wrap);let l=c.getNext();for(;l;)l.name!==e.name&&a.push(l),l=c.getNext();return a.push(e),xn(a,o.getCompare())}else return it;else{const a=t.get(e.name);let c=s;return a&&(c=c.remove(new w(e.name,a))),c.insert(e,e.node)}});return new he(i,this.indexSet_)}removeFromIndexes(e,t){const i=Cn(this.indexes_,s=>{if(s===it)return s;{const r=t.get(e.name);return r?s.remove(new w(e.name,r)):s}});return new he(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Nt;class _{constructor(e,t,i){this.children_=e,this.priorityNode_=t,this.indexMap_=i,this.lazyHash_=null,this.priorityNode_&&Nc(this.priorityNode_),this.children_.isEmpty()&&p(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}static get EMPTY_NODE(){return Nt||(Nt=new _(new W(Ws),null,he.Default))}isLeafNode(){return!1}getPriority(){return this.priorityNode_||Nt}updatePriority(e){return this.children_.isEmpty()?this:new _(this.children_,e,this.indexMap_)}getImmediateChild(e){if(e===".priority")return this.getPriority();{const t=this.children_.get(e);return t===null?Nt:t}}getChild(e){const t=y(e);return t===null?this:this.getImmediateChild(t).getChild(k(e))}hasChild(e){return this.children_.get(e)!==null}updateImmediateChild(e,t){if(p(t,"We should always be passing snapshot nodes"),e===".priority")return this.updatePriority(t);{const i=new w(e,t);let s,r;t.isEmpty()?(s=this.children_.remove(e),r=this.indexMap_.removeFromIndexes(i,this.children_)):(s=this.children_.insert(e,t),r=this.indexMap_.addToIndexes(i,this.children_));const o=s.isEmpty()?Nt:this.priorityNode_;return new _(s,o,r)}}updateChild(e,t){const i=y(e);if(i===null)return t;{p(y(e)!==".priority"||De(e)===1,".priority must be the last token in a path");const s=this.getImmediateChild(i).updateChild(k(e),t);return this.updateImmediateChild(i,s)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let i=0,s=0,r=!0;if(this.forEachChild(P,(o,a)=>{t[o]=a.val(e),i++,r&&_.INTEGER_REGEXP_.test(o)?s=Math.max(s,Number(o)):r=!1}),!e&&r&&s<2*i){const o=[];for(const a in t)o[a]=t[a];return o}else return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(this.lazyHash_===null){let e="";this.getPriority().isEmpty()||(e+="priority:"+Ac(this.getPriority().val())+":"),this.forEachChild(P,(t,i)=>{const s=i.hash();s!==""&&(e+=":"+t+":"+s)}),this.lazyHash_=e===""?"":sc(e)}return this.lazyHash_}getPredecessorChildName(e,t,i){const s=this.resolveIndex_(i);if(s){const r=s.getPredecessorKey(new w(e,t));return r?r.name:null}else return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const i=t.minKey();return i&&i.name}else return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new w(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const i=t.maxKey();return i&&i.name}else return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new w(t,this.children_.get(t)):null}forEachChild(e,t){const i=this.resolveIndex_(e);return i?i.inorderTraversal(s=>t(s.name,s.node)):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const i=this.resolveIndex_(t);if(i)return i.getIteratorFrom(e,s=>s);{const s=this.children_.getIteratorFrom(e.name,w.Wrap);let r=s.peek();for(;r!=null&&t.compare(r,e)<0;)s.getNext(),r=s.peek();return s}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const i=this.resolveIndex_(t);if(i)return i.getReverseIteratorFrom(e,s=>s);{const s=this.children_.getReverseIteratorFrom(e.name,w.Wrap);let r=s.peek();for(;r!=null&&t.compare(r,e)>0;)s.getNext(),r=s.peek();return s}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===cn?-1:0}withIndex(e){if(e===ut||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new _(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===ut||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority()))if(this.children_.count()===t.children_.count()){const i=this.getIterator(P),s=t.getIterator(P);let r=i.getNext(),o=s.getNext();for(;r&&o;){if(r.name!==o.name||!r.node.equals(o.node))return!1;r=i.getNext(),o=s.getNext()}return r===null&&o===null}else return!1;else return!1}}resolveIndex_(e){return e===ut?null:this.indexMap_.get(e.toString())}}_.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;class dg extends _{constructor(){super(new W(Ws),_.EMPTY_NODE,he.Default)}compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return _.EMPTY_NODE}isEmpty(){return!1}}const cn=new dg;Object.defineProperties(w,{MIN:{value:new w(ft,_.EMPTY_NODE)},MAX:{value:new w(ze,cn)}});kc.__EMPTY_NODE=_.EMPTY_NODE;L.__childrenNodeConstructor=_;rg(cn);ag(cn);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hs{constructor(e){this.index_=e}updateChild(e,t,i,s,r,o){p(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(i.getChild(s))&&a.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(t)?o.trackChildChange(Gt(t,a)):p(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(pt(t,i)):o.trackChildChange(zt(t,i,a))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(t,i).withIndex(this.index_)}updateFullNode(e,t,i){return i!=null&&(e.isLeafNode()||e.forEachChild(P,(s,r)=>{t.hasChild(s)||i.trackChildChange(Gt(s,r))}),t.isLeafNode()||t.forEachChild(P,(s,r)=>{if(e.hasChild(s)){const o=e.getImmediateChild(s);o.equals(r)||i.trackChildChange(zt(s,r,o))}else i.trackChildChange(pt(s,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?_.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fn extends Ic{constructor(e,t,i,s){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=i,this.appCheckTokenProvider_=s,this.log_=an("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(p(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,i,s){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=Fn.getListenId_(e,i),a={};this.listens_[o]=a;const c=Co(e._queryParams);this.restRequest_(r+".json",c,(l,u)=>{let d=u;if(l===404&&(d=null,l=null),l===null&&this.onDataUpdate_(r,d,!1,i),ht(this.listens_,o)===a){let h;l?l===401?h="permission_denied":h="rest_error:"+l:h="ok",s(h,null)}})}unlisten(e,t){const i=Fn.getListenId_(e,t);delete this.listens_[i]}get(e){const t=Co(e._queryParams),i=e._path.toString(),s=new en;return this.restRequest_(i+".json",t,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(i,a,!1,null),s.resolve(a)):s.reject(new Error(a))}),s.promise}refreshAuthToken(e){}restRequest_(e,t={},i){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([s,r])=>{s&&s.accessToken&&(t.auth=s.accessToken),r&&r.token&&(t.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+wt(t);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(i&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let c=null;if(a.status>=200&&a.status<300){try{c=Vt(a.responseText)}catch{V("Failed to parse JSON response for "+o+": "+a.responseText)}i(null,c)}else a.status!==401&&a.status!==404&&V("Got unsuccessful REST response for "+o+" Status: "+a.status),i(a.status);i=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ko=10*1e3,bg=30*1e3,Ig=5*60*1e3;class Tg{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Eg(e);const i=ko+(bg-ko)*Math.random();xt(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),t={};let i=!1;F(e,(s,r)=>{r>0&&oe(this.statsToReport_,s)&&(t[s]=r,i=!0)}),i&&this.server_.reportStats(t),xt(this.reportStats_.bind(this),Math.floor(Math.random()*2*Ig))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gt{constructor(e,t,i){this.source=e,this.path=t,this.children=i,this.type=X.MERGE}operationForChild(e){if(E(this.path)){const t=this.children.subtree(new T(e));return t.isEmpty()?null:t.value?new Ke(this.source,b(),t.value):new gt(this.source,b(),t)}else return p(y(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new gt(this.source,k(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cg{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Sg(n,e,t,i){const s=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(mg(o.childName,o.snapshotNode))}),Rt(n,s,"child_removed",e,i,t),Rt(n,s,"child_added",e,i,t),Rt(n,s,"child_moved",r,i,t),Rt(n,s,"child_changed",e,i,t),Rt(n,s,"value",e,i,t),s}function Rt(n,e,t,i,s,r){const o=i.filter(a=>a.type===t);o.sort((a,c)=>Ag(n,a,c)),o.forEach(a=>{const c=kg(n,a,r);s.forEach(l=>{l.respondsTo(a.type)&&e.push(l.createEvent(c,n.query_))})})}function kg(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function Ag(n,e,t){if(e.childName==null||t.childName==null)throw yt("Should only compare child_ events.");const i=new w(e.childName,e.snapshotNode),s=new w(t.childName,t.snapshotNode);return n.index_.compare(i,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ri(n,e){return{eventCache:n,serverCache:e}}function Ft(n,e,t,i){return ri(new Le(e,t,i),n.serverCache)}function Lc(n,e,t,i){return ri(n.eventCache,new Le(e,t,i))}function Vn(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Ye(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oi(n,e){return Bc(e,n)}function Rg(n,e,t,i,s){p(i>n.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),n.allWrites.push({path:e,snap:t,writeId:i,visible:s}),s&&(n.visibleWrites=Ut(n.visibleWrites,e,t)),n.lastWriteId=i}function Pg(n,e,t,i){p(i>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:i,visible:!0}),n.visibleWrites=es(n.visibleWrites,e,t),n.lastWriteId=i}function Og(n,e){for(let t=0;t<n.allWrites.length;t++){const i=n.allWrites[t];if(i.writeId===e)return i}return null}function Dg(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);p(t>=0,"removeWrite called with nonexistent writeId.");const i=n.allWrites[t];n.allWrites.splice(t,1);let s=i.visible,r=!1,o=n.allWrites.length-1;for(;s&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&Lg(a,i.path)?s=!1:j(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return Mg(n),!0;if(i.snap)n.visibleWrites=Ao(n.visibleWrites,i.path);else{const a=i.children;F(a,c=>{n.visibleWrites=Ao(n.visibleWrites,R(i.path,c))})}return!0}else return!1}function Lg(n,e){if(n.snap)return j(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&j(R(n.path,t),e))return!0;return!1}function Mg(n){n.visibleWrites=xc(n.allWrites,xg,b()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function xg(n){return n.visible}function xc(n,e,t){let i=ee.empty();for(let s=0;s<n.length;++s){const r=n[s];if(e(r)){const o=r.path;let a;if(r.snap)j(t,o)?(a=B(t,o),i=Ut(i,a,r.snap)):j(o,t)&&(a=B(o,t),i=Ut(i,b(),r.snap.getChild(a)));else if(r.children){if(j(t,o))a=B(t,o),i=es(i,a,r.children);else if(j(o,t))if(a=B(o,t),E(a))i=es(i,b(),r.children);else{const c=ht(r.children,y(a));if(c){const l=c.getChild(k(a));i=Ut(i,b(),l)}}}else throw yt("WriteRecord should have .snap or .children")}}return i}function Fc(n,e,t,i,s){if(!i&&!s){const r=nt(n.visibleWrites,e);if(r!=null)return r;{const o=Pe(n.visibleWrites,e);if(ns(o))return t;if(t==null&&!ts(o,b()))return null;{const a=t||_.EMPTY_NODE;return mt(o,a)}}}else{const r=Pe(n.visibleWrites,e);if(!s&&ns(r))return t;if(!s&&t==null&&!ts(r,b()))return null;{const o=function(l){return(l.visible||s)&&(!i||!~i.indexOf(l.writeId))&&(j(l.path,e)||j(e,l.path))},a=xc(n.allWrites,o,e),c=t||_.EMPTY_NODE;return mt(a,c)}}}function Fg(n,e,t){let i=_.EMPTY_NODE;const s=nt(n.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(P,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(t){const r=Pe(n.visibleWrites,e);return t.forEachChild(P,(o,a)=>{const c=mt(Pe(r,new T(o)),a);i=i.updateImmediateChild(o,c)}),No(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=Pe(n.visibleWrites,e);return No(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function Ug(n,e,t,i,s){p(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=R(e,t);if(ts(n.visibleWrites,r))return null;{const o=Pe(n.visibleWrites,r);return ns(o)?s.getChild(t):mt(o,s.getChild(t))}}function Bg(n,e,t,i){const s=R(e,t),r=nt(n.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(t)){const o=Pe(n.visibleWrites,s);return mt(o,i.getNode().getImmediateChild(t))}else return null}function Vg(n,e){return nt(n.visibleWrites,e)}function $g(n,e,t,i,s,r,o){let a;const c=Pe(n.visibleWrites,e),l=nt(c,b());if(l!=null)a=l;else if(t!=null)a=mt(c,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],d=o.getCompare(),h=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let f=h.getNext();for(;f&&u.length<s;)d(f,i)!==0&&u.push(f),f=h.getNext();return u}else return[]}function Wg(){return{visibleWrites:ee.empty(),allWrites:[],lastWriteId:-1}}function $n(n,e,t,i){return Fc(n.writeTree,n.treePath,e,t,i)}function Ks(n,e){return Fg(n.writeTree,n.treePath,e)}function Ro(n,e,t,i){return Ug(n.writeTree,n.treePath,e,t,i)}function Wn(n,e){return Vg(n.writeTree,R(n.treePath,e))}function Hg(n,e,t,i,s,r){return $g(n.writeTree,n.treePath,e,t,i,s,r)}function Ys(n,e,t){return Bg(n.writeTree,n.treePath,e,t)}function Uc(n,e){return Bc(R(n.treePath,e),n.writeTree)}function Bc(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let qn;function dm(n){p(!qn,"__referenceConstructor has already been defined"),qn=n}function hm(){return p(qn,"Reference.ts has not been loaded"),qn}let fm=1;class xo{constructor(e){this.listenProvider_=e,this.syncPointTree_=new S(null),this.pendingWriteTree_=Wg(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Kc(n,e,t,i,s){return Rg(n.pendingWriteTree_,e,t,i,s),s?Tt(n,new Ke(qs(),e,t)):[]}function pm(n,e,t,i){Pg(n.pendingWriteTree_,e,t,i);const s=S.fromObject(t);return Tt(n,new gt(qs(),e,s))}function Ne(n,e,t=!1){const i=Og(n.pendingWriteTree_,e);if(Dg(n.pendingWriteTree_,e)){let r=new S(null);return i.snap!=null?r=r.set(b(),!0):F(i.children,o=>{r=r.set(new T(o),!0)}),Tt(n,new Bn(i.path,r,t))}else return[]}function ln(n,e,t){return Tt(n,new Ke(Gs(),e,t))}function gm(n,e,t){const i=S.fromObject(t);return Tt(n,new gt(Gs(),e,i))}function mm(n,e){return Tt(n,new Yt(Gs(),e))}function _m(n,e,t){const i=Zs(n,t);if(i){const s=er(i),r=s.path,o=s.queryId,a=B(r,e),c=new Yt(zs(o),a);return tr(n,r,c)}else return[]}function Gn(n,e,t,i,s=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||zc(o,e))){const c=um(o,e,t,i);cm(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const l=c.removed;if(a=c.events,!s){const u=l.findIndex(h=>h._queryParams.loadsAllData())!==-1,d=n.syncPointTree_.findOnPath(r,(h,f)=>Me(f));if(u&&!d){const h=n.syncPointTree_.subtree(r);if(!h.isEmpty()){const f=wm(h);for(let g=0;g<f.length;++g){const v=f[g],C=v.query,Y=Xc(n,v);n.listenProvider_.startListening(Bt(C),Jt(n,C),Y.hashFn,Y.onComplete)}}}!d&&l.length>0&&!i&&(u?n.listenProvider_.stopListening(Bt(e),null):l.forEach(h=>{const f=n.queryToTagMap.get(ci(h));n.listenProvider_.stopListening(Bt(h),f)}))}Em(n,l)}return a}function Yc(n,e,t,i){const s=Zs(n,i);if(s!=null){const r=er(s),o=r.path,a=r.queryId,c=B(o,e),l=new Ke(zs(a),c,t);return tr(n,o,l)}else return[]}function vm(n,e,t,i){const s=Zs(n,i);if(s){const r=er(s),o=r.path,a=r.queryId,c=B(o,e),l=S.fromObject(t),u=new gt(zs(a),c,l);return tr(n,o,u)}else return[]}function rs(n,e,t,i=!1){const s=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(s,(h,f)=>{const g=B(h,s);r=r||Oe(f,g),o=o||Me(f)});let a=n.syncPointTree_.get(s);a?(o=o||Me(a),r=r||Oe(a,b())):(a=new Hc,n.syncPointTree_=n.syncPointTree_.set(s,a));let c;r!=null?c=!0:(c=!1,r=_.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((f,g)=>{const v=Oe(g,b());v&&(r=r.updateImmediateChild(f,v))}));const l=zc(a,e);if(!l&&!e._queryParams.loadsAllData()){const h=ci(e);p(!n.queryToTagMap.has(h),"View does not exist, but we have a tag");const f=bm();n.queryToTagMap.set(h,f),n.tagToQueryMap.set(f,h)}const u=oi(n.pendingWriteTree_,s);let d=lm(a,e,t,u,r,c);if(!l&&!o&&!i){const h=Gc(a,e);d=d.concat(Im(n,e,h))}return d}function Xs(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const c=B(o,e),l=Oe(a,c);if(l)return l});return Fc(s,e,r,t,!0)}function ym(n,e){const t=e._path;let i=null;n.syncPointTree_.foreachOnPath(t,(l,u)=>{const d=B(l,t);i=i||Oe(u,d)});let s=n.syncPointTree_.get(t);s?i=i||Oe(s,b()):(s=new Hc,n.syncPointTree_=n.syncPointTree_.set(t,s));const r=i!=null,o=r?new Le(i,!0,!1):null,a=oi(n.pendingWriteTree_,e._path),c=jc(s,e,a,r?o.getNode():_.EMPTY_NODE,r);return nm(c)}function Tt(n,e){return Jc(e,n.syncPointTree_,null,oi(n.pendingWriteTree_,b()))}function Jc(n,e,t,i){if(E(n.path))return Qc(n,e,t,i);{const s=e.get(b());t==null&&s!=null&&(t=Oe(s,b()));let r=[];const o=y(n.path),a=n.operationForChild(o),c=e.children.get(o);if(c&&a){const l=t?t.getImmediateChild(o):null,u=Uc(i,o);r=r.concat(Jc(a,c,l,u))}return s&&(r=r.concat(Qs(s,n,i,t))),r}}function Qc(n,e,t,i){const s=e.get(b());t==null&&s!=null&&(t=Oe(s,b()));let r=[];return e.children.inorderTraversal((o,a)=>{const c=t?t.getImmediateChild(o):null,l=Uc(i,o),u=n.operationForChild(o);u&&(r=r.concat(Qc(u,a,c,l)))}),s&&(r=r.concat(Qs(s,n,i,t))),r}function Xc(n,e){const t=e.query,i=Jt(n,t);return{hashFn:()=>(tm(e)||_.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?_m(n,t._path,i):mm(n,t._path);{const r=mp(s,t);return Gn(n,t,null,r)}}}}function Jt(n,e){const t=ci(e);return n.queryToTagMap.get(t)}function ci(n){return n._path.toString()+"$"+n._queryIdentifier}function Zs(n,e){return n.tagToQueryMap.get(e)}function er(n){const e=n.indexOf("$");return p(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new T(n.substr(0,e))}}function tr(n,e,t){const i=n.syncPointTree_.get(e);p(i,"Missing sync point for query tag that we're tracking");const s=oi(n.pendingWriteTree_,e);return Qs(i,t,s,null)}function wm(n){return n.fold((e,t,i)=>{if(t&&Me(t))return[ai(t)];{let s=[];return t&&(s=qc(t)),F(i,(r,o)=>{s=s.concat(o)}),s}})}function Bt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(hm())(n._repo,n._path):n}function Em(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const s=ci(i),r=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(r)}}}function bm(){return fm++}function Im(n,e,t){const i=e._path,s=Jt(n,e),r=Xc(n,t),o=n.listenProvider_.startListening(Bt(e),s,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(i);if(s)p(!Me(a.value),"If we're adding a query, it shouldn't be shadowed");else{const c=a.fold((l,u,d)=>{if(!E(l)&&u&&Me(u))return[ai(u).query];{let h=[];return u&&(h=h.concat(qc(u).map(f=>f.query))),F(d,(f,g)=>{h=h.concat(g)}),h}});for(let l=0;l<c.length;++l){const u=c[l];n.listenProvider_.stopListening(Bt(u),Jt(n,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bm{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function di(n,e){let t=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();t!==null&&!Vs(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(s)}t&&n.eventLists_.push(t)}function al(n,e,t){di(n,t),cl(n,i=>Vs(i,e))}function K(n,e,t){di(n,t),cl(n,i=>j(i,e)||j(e,i))}function cl(n,e){n.recursionDepth_++;let t=!0;for(let i=0;i<n.eventLists_.length;i++){const s=n.eventLists_[i];if(s){const r=s.path;e(r)?(Vm(n.eventLists_[i]),n.eventLists_[i]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function Vm(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const i=t.getEventRunner();Mt&&x("event: "+t.toString()),It(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $m="repo_interrupt",Wm=25;class Hm{constructor(e,t,i,s){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=i,this.appCheckProvider_=s,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Bm,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Un(),this.transactionQueueTree_=new rr,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function jm(n,e,t){if(n.stats_=Fs(n.repoInfo_),n.forceRestClient_||wp())n.server_=new Fn(n.repoInfo_,(i,s,r,o)=>{Uo(n,i,s,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>Bo(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{D(t)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}n.persistentConnection_=new ge(n.repoInfo_,e,(i,s,r,o)=>{Uo(n,i,s,r,o)},i=>{Bo(n,i)},i=>{Gm(n,i)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(i=>{n.server_.refreshAuthToken(i)}),n.appCheckProvider_.addTokenChangeListener(i=>{n.server_.refreshAppCheckToken(i.token)}),n.statsReporter_=Cp(n.repoInfo_,()=>new Tg(n.stats_,n.server_)),n.infoData_=new yg,n.infoSyncTree_=new xo({startListening:(i,s,r,o)=>{let a=[];const c=n.infoData_.getNode(i._path);return c.isEmpty()||(a=ln(n.infoSyncTree_,i._path,c),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),cr(n,"connected",!1),n.serverSyncTree_=new xo({startListening:(i,s,r,o)=>(n.server_.listen(i,r,s,(a,c)=>{const l=o(a,c);K(n.eventQueue_,i._path,l)}),[]),stopListening:(i,s)=>{n.server_.unlisten(i,s)}})}function qm(n){const t=n.infoData_.getNode(new T(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function hi(n){return Tm({timestamp:qm(n)})}function Uo(n,e,t,i,s){n.dataUpdateCount++;const r=new T(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(s)if(i){const c=Cn(t,l=>O(l));o=vm(n.serverSyncTree_,r,c,s)}else{const c=O(t);o=Yc(n.serverSyncTree_,r,c,s)}else if(i){const c=Cn(t,l=>O(l));o=gm(n.serverSyncTree_,r,c)}else{const c=O(t);o=ln(n.serverSyncTree_,r,c)}let a=r;o.length>0&&(a=_t(n,r)),K(n.eventQueue_,a,o)}function Bo(n,e){cr(n,"connected",e),e===!1&&Jm(n)}function Gm(n,e){F(e,(t,i)=>{cr(n,t,i)})}function cr(n,e,t){const i=new T("/.info/"+e),s=O(t);n.infoData_.updateSnapshot(i,s);const r=ln(n.infoSyncTree_,i,s);K(n.eventQueue_,i,r)}function lr(n){return n.nextWriteId_++}function zm(n,e,t){const i=ym(n.serverSyncTree_,e);return i!=null?Promise.resolve(i):n.server_.get(e).then(s=>{const r=O(s).withIndex(e._queryParams.getIndex());rs(n.serverSyncTree_,e,t,!0);let o;if(e._queryParams.loadsAllData())o=ln(n.serverSyncTree_,e._path,r);else{const a=Jt(n.serverSyncTree_,e);o=Yc(n.serverSyncTree_,e._path,r,a)}return K(n.eventQueue_,e._path,o),Gn(n.serverSyncTree_,e,t,null,!0),r},s=>(dn(n,"get for query "+D(e)+" failed: "+s),Promise.reject(new Error(s))))}function Km(n,e,t,i,s){dn(n,"set",{path:e.toString(),value:t,priority:i});const r=hi(n),o=O(t,i),a=Xs(n.serverSyncTree_,e),c=el(o,a,r),l=lr(n),u=Kc(n.serverSyncTree_,e,c,l,!0);di(n.eventQueue_,u),n.server_.put(e.toString(),o.val(!0),(h,f)=>{const g=h==="ok";g||V("set at "+e+" failed: "+h);const v=Ne(n.serverSyncTree_,l,!g);K(n.eventQueue_,e,v),as(n,s,h,f)});const d=dr(n,e);_t(n,d),K(n.eventQueue_,d,[])}function Ym(n,e,t,i){dn(n,"update",{path:e.toString(),value:t});let s=!0;const r=hi(n),o={};if(F(t,(a,c)=>{s=!1,o[a]=Zc(R(e,a),O(c),n.serverSyncTree_,r)}),s)x("update() called with empty data.  Don't do anything."),as(n,i,"ok",void 0);else{const a=lr(n),c=pm(n.serverSyncTree_,e,o,a);di(n.eventQueue_,c),n.server_.merge(e.toString(),t,(l,u)=>{const d=l==="ok";d||V("update at "+e+" failed: "+l);const h=Ne(n.serverSyncTree_,a,!d),f=h.length>0?_t(n,e):e;K(n.eventQueue_,f,h),as(n,i,l,u)}),F(t,l=>{const u=dr(n,R(e,l));_t(n,u)}),K(n.eventQueue_,e,[])}}function Jm(n){dn(n,"onDisconnectEvents");const e=hi(n),t=Un();Zi(n.onDisconnect_,b(),(s,r)=>{const o=Zc(s,r,n.serverSyncTree_,e);Dc(t,s,o)});let i=[];Zi(t,b(),(s,r)=>{i=i.concat(ln(n.serverSyncTree_,s,r));const o=dr(n,s);_t(n,o)}),n.onDisconnect_=Un(),K(n.eventQueue_,b(),i)}function Qm(n,e,t){let i;y(e._path)===".info"?i=rs(n.infoSyncTree_,e,t):i=rs(n.serverSyncTree_,e,t),al(n.eventQueue_,e._path,i)}function Xm(n,e,t){let i;y(e._path)===".info"?i=Gn(n.infoSyncTree_,e,t):i=Gn(n.serverSyncTree_,e,t),al(n.eventQueue_,e._path,i)}function Zm(n){n.persistentConnection_&&n.persistentConnection_.interrupt($m)}function dn(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),x(t,...e)}function as(n,e,t,i){e&&It(()=>{if(t==="ok")e(null);else{const s=(t||"error").toUpperCase();let r=s;i&&(r+=": "+i);const o=new Error(r);o.code=s,e(o)}})}function ll(n,e,t){return Xs(n.serverSyncTree_,e,t)||_.EMPTY_NODE}function ur(n,e=n.transactionQueueTree_){if(e||fi(n,e),Ct(e)){const t=dl(n,e);p(t.length>0,"Sending zero length transaction queue"),t.every(s=>s.status===0)&&e_(n,un(e),t)}else nl(e)&&li(e,t=>{ur(n,t)})}function e_(n,e,t){const i=t.map(l=>l.currentWriteId),s=ll(n,e,i);let r=s;const o=s.hash();for(let l=0;l<t.length;l++){const u=t[l];p(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const d=B(e,u.path);r=r.updateChild(d,u.currentOutputSnapshotRaw)}const a=r.val(!0),c=e;n.server_.put(c.toString(),a,l=>{dn(n,"transaction put response",{path:c.toString(),status:l});let u=[];if(l==="ok"){const d=[];for(let h=0;h<t.length;h++)t[h].status=2,u=u.concat(Ne(n.serverSyncTree_,t[h].currentWriteId)),t[h].onComplete&&d.push(()=>t[h].onComplete(null,!0,t[h].currentOutputSnapshotResolved)),t[h].unwatcher();fi(n,or(n.transactionQueueTree_,e)),ur(n,n.transactionQueueTree_),K(n.eventQueue_,e,u);for(let h=0;h<d.length;h++)It(d[h])}else{if(l==="datastale")for(let d=0;d<t.length;d++)t[d].status===3?t[d].status=4:t[d].status=0;else{V("transaction at "+c.toString()+" failed: "+l);for(let d=0;d<t.length;d++)t[d].status=4,t[d].abortReason=l}_t(n,e)}},o)}function _t(n,e){const t=ul(n,e),i=un(t),s=dl(n,t);return t_(n,s,i),i}function t_(n,e,t){if(e.length===0)return;const i=[];let s=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const c=e[a],l=B(t,c.path);let u=!1,d;if(p(l!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),c.status===4)u=!0,d=c.abortReason,s=s.concat(Ne(n.serverSyncTree_,c.currentWriteId,!0));else if(c.status===0)if(c.retryCount>=Wm)u=!0,d="maxretry",s=s.concat(Ne(n.serverSyncTree_,c.currentWriteId,!0));else{const h=ll(n,c.path,o);c.currentInputSnapshot=h;const f=e[a].update(h.val());if(f!==void 0){ui("transaction failed: Data returned ",f,c.path);let g=O(f);typeof f=="object"&&f!=null&&oe(f,".priority")||(g=g.updatePriority(h.getPriority()));const C=c.currentWriteId,Y=hi(n),Fe=el(g,h,Y);c.currentOutputSnapshotRaw=g,c.currentOutputSnapshotResolved=Fe,c.currentWriteId=lr(n),o.splice(o.indexOf(C),1),s=s.concat(Kc(n.serverSyncTree_,c.path,Fe,c.currentWriteId,c.applyLocally)),s=s.concat(Ne(n.serverSyncTree_,C,!0))}else u=!0,d="nodata",s=s.concat(Ne(n.serverSyncTree_,c.currentWriteId,!0))}K(n.eventQueue_,t,s),s=[],u&&(e[a].status=2,function(h){setTimeout(h,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(d==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(d),!1,null))))}fi(n,n.transactionQueueTree_);for(let a=0;a<i.length;a++)It(i[a]);ur(n,n.transactionQueueTree_)}function ul(n,e){let t,i=n.transactionQueueTree_;for(t=y(e);t!==null&&Ct(i)===void 0;)i=or(i,t),e=k(e),t=y(e);return i}function dl(n,e){const t=[];return hl(n,e,t),t.sort((i,s)=>i.order-s.order),t}function hl(n,e,t){const i=Ct(e);if(i)for(let s=0;s<i.length;s++)t.push(i[s]);li(e,s=>{hl(n,s,t)})}function fi(n,e){const t=Ct(e);if(t){let i=0;for(let s=0;s<t.length;s++)t[s].status!==2&&(t[i]=t[s],i++);t.length=i,tl(e,t.length>0?t:void 0)}li(e,i=>{fi(n,i)})}function dr(n,e){const t=un(ul(n,e)),i=or(n.transactionQueueTree_,e);return Am(i,s=>{Li(n,s)}),Li(n,i),il(i,s=>{Li(n,s)}),t}function Li(n,e){const t=Ct(e);if(t){const i=[];let s=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(p(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(p(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),s=s.concat(Ne(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&i.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?tl(e,void 0):t.length=r+1,K(n.eventQueue_,un(e),s);for(let o=0;o<i.length;o++)It(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function __(n){rp(Et),ne(new G("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return h_(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),H(co,lo,n),H(co,lo,"esm2017")}ge.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};ge.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};__();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $o={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class dt extends re{constructor(e,t,i){super(`${gr}/${e}`,t||""),this.details=i}}function w_(n){if(n>=200&&n<300)return"ok";switch(n){case 0:return"internal";case 400:return"invalid-argument";case 401:return"unauthenticated";case 403:return"permission-denied";case 404:return"not-found";case 409:return"aborted";case 429:return"resource-exhausted";case 499:return"cancelled";case 500:return"internal";case 501:return"unimplemented";case 503:return"unavailable";case 504:return"deadline-exceeded"}return"unknown"}function E_(n,e){let t=w_(n),i=t,s;try{const r=e&&e.error;if(r){const o=r.status;if(typeof o=="string"){if(!$o[o])return new dt("internal","internal");t=$o[o],i=o}const a=r.message;typeof a=="string"&&(i=a),s=r.details,s!==void 0&&(s=zn(s))}}catch{}return t==="ok"?null:new dt(t,i,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cy(n,e){const t=e.data;if(!t.isFirebaseMessaging)return;n.onMessageHandler&&t.messageType===Xt.PUSH_RECEIVED&&(typeof n.onMessageHandler=="function"?n.onMessageHandler(Xo(t)):n.onMessageHandler.next(Xo(t)));const i=t.data;ey(i)&&i[Lv]==="1"&&await oy(n,t.messageType,i)}const Zo="@firebase/messaging",ea="0.12.12";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function py(n=ei()){return hy().then(e=>{if(!e)throw U.create("unsupported-browser")},e=>{throw U.create("indexed-db-unsupported")}),et(A(n),"messaging").getImmediate()}async function gy(n,e){return n=A(n),Jl(n,e)}function my(n,e){return n=A(n),fy(n,e)}dy();const vt="fcm_token",Xe="fcm_subscriptions";let je=null,rt=null,kr=null,Ce=!1;async function _y(){if(!(je&&rt)){if(!("serviceWorker"in navigator)){console.error("❌ Este navegador no soporta Service Worker");return}try{const n="./firebase-messaging-sw.js";console.log("🔧 Registrando Service Worker:",n),rt=await navigator.serviceWorker.register(n,{scope:"/ProtexHome"}),console.log("✅ Service Worker registrado"),console.log("✅ SW scope:",rt.scope),await navigator.serviceWorker.ready,console.log("✅ Service Worker listo"),je=py(xe),console.log("✅ Firebase Messaging inicializado")}catch(n){console.error("❌ ERROR INICIALIZANDO FCM"),console.error(n),je=null,rt=null}}}kr=_y();function vy(n){const{A:e,D:t,E:i,N:s,S:r}=n,o=String(t||0).padStart(2,"0"),a=s||"Usuario";let l=`📢 ${r||""}`,u="",d="🔔",h="#6b7280";switch(Number(i)){case 1:l=`🚨 Alarma en Zona ${o}`,u=`Partición ${e} • ${a}`,d="🚨",h="#dc2626";break;case 2:l=`✅ Restauración en Zona ${o}`,u=`Partición ${e} • ${a}`,d="✅",h="#16a34a";break;case 3:{l=`⚠️ Falla: ${{1:"Batería baja",2:"Falla de sirena",3:"Falla de línea telefónica",4:"Falla de comunicación"}[t]||`Falla (código ${t})`}`,u=`Partición ${e}`,d="⚠️",h="#d97706";break}case 4:{l=`🔄 ${{1:"Batería baja restaurada",2:"Sirena restaurada",3:"Línea telefónica restaurada",4:"Comunicación restaurada"}[t]||`Falla restaurada (código ${t})`}`,u=`Partición ${e}`,d="🔄",h="#a16207";break}case 5:l=`🔓 Apertura por usuario ${o}`,u=`${a} • Partición ${e}`,d="🔓",h="#2563eb";break;case 6:l=`🔒 Cierre por usuario ${o}`,u=`${a} • Partición ${e}`,d="🔒",h="#7c3aed";break;case 7:{l=`🔥 ${{0:"Fuego",1:"Alarma médica",2:"Pánico de teclado"}[t]||`Alarma (código ${t})`}`,u=`Partición ${e}`,d="🔥",h="#b91c1c";break}default:l=`📩 Evento ${i}`,u=`Partición ${e} • ${a}`,d="📩",h="#6b7280"}return e==9&&(u=u.replace("Partición","Global")),{title:l,body:u,icon:d,color:h}}function yy(n){if(console.log("🔔 showEventNotification llamado con:",n),console.log("🔔 Permiso actual:",Notification.permission),!("Notification"in window)||Notification.permission!=="granted"){console.warn("🔕 Permiso de notificaciones no concedido");return}const{title:e,body:t,color:i}=vy(n);console.log("📝 Título:",e,"Cuerpo:",t);const s={body:t,icon:"./assets/icon-512.png",badge:"./assets/icon-512.png",tag:`event-${n.S||"unknown"}-${n.D}-${Date.now()}`,requireInteraction:!0,data:{payload:n}};Notification.prototype.hasOwnProperty("color")&&(s.color=i);const r=new Notification(e,s);return r.onclick=o=>{o.preventDefault(),window.focus(),console.log("🔔 Clic en notificación (foreground):",n),n.S},r}async function Ql(){const n=localStorage.getItem(vt);if(n&&Notification.permission==="granted")return console.log("ℹ️ Ya hay token y permiso concedido, omitiendo solicitud"),{success:!0,token:n};if(Ce)return console.log("ℹ️ Solicitud de permiso ya en curso, esperando..."),new Promise(e=>{const t=setInterval(()=>{Ce||(clearInterval(t),e(Ql()))},200)});Ce=!0;try{if(await kr,!je||!rt)return Ce=!1,{success:!1,error:"Messaging no disponible"};const e=await Notification.requestPermission();if(console.log("🔔 Permiso de notificaciones:",e),e!=="granted")return Ce=!1,{success:!1,error:"Permiso denegado"};const t=await gy(je,{vapidKey:"BGqsW_ZEnJVC5kfKwtLdz6QUhhciFu53Z-ObyRwNsWscwYNA14eBFHxNn1HFVxsGSUpniXgnddgsRbGfqcmuQyI",serviceWorkerRegistration:rt});return t?(console.log("🔥 Token FCM:",t),localStorage.setItem(vt,t),Ce=!1,{success:!0,token:t}):(Ce=!1,{success:!1,error:"No se pudo obtener el token"})}catch(e){return console.error("❌ Error solicitando permiso:",e),Ce=!1,{success:!1,error:e.message}}}async function Vi(n,e){const t=localStorage.getItem(vt);if(!t){console.warn("⚠️ No hay token para sincronizar suscripciones");return}const i=JSON.parse(localStorage.getItem(Xe)||"{}"),s=mr(xe),r=_r(s,"subscribeToSerialTopic");for(const o of e)if(i[o]!==t)try{await r({serial:o,token:t}),i[o]=t,console.log("✅ Suscrito al topic",o)}catch(a){console.warn("⚠️ No se pudo suscribir al topic",o,a.message)}for(const o of Object.keys(i))e.includes(o)||delete i[o];localStorage.setItem(Xe,JSON.stringify(i))}async function wy(n,e){const t=localStorage.getItem(vt);if(!t)return;const i=JSON.parse(localStorage.getItem(Xe)||"{}");if(i[e]===t)return;const s=mr(xe),r=_r(s,"subscribeToSerialTopic");try{await r({serial:e,token:t}),i[e]=t,localStorage.setItem(Xe,JSON.stringify(i)),console.log("✅ Suscrito al nuevo topic",e)}catch(o){console.warn("⚠️ No se pudo suscribir al topic",e,o.message)}}async function Ty(n){const e=localStorage.getItem(vt);if(!e)return{success:!1,error:"No hay token"};const t=mr(xe),i=_r(t,"unsubscribeFromSerialTopic");try{await i({serial:n,token:e});const s=JSON.parse(localStorage.getItem(Xe)||"{}");return delete s[n],localStorage.setItem(Xe,JSON.stringify(s)),{success:!0}}catch(s){return console.error("❌ Error desuscribiendo:",s),{success:!1,error:s.message}}}function ta(){localStorage.removeItem(vt),localStorage.removeItem(Xe)}async function Ey(n){try{if(await kr,!je){console.warn("⚠️ Messaging no está disponible");return}my(je,e=>{n(e)}),console.log("✅ Listener de mensajes en primer plano registrado")}catch(e){console.error("❌ No se pudo registrar onMessage:",e)}}class by{constructor(){this.pwa=null,this.authController=null,this.dashboardController=null,this.currentUser=null,this.cachedDashboard=null,this.activeView=null,this.backgroundTimer=null,this.currentSerial=null,this.init()}async init(){if(console.log("🚀 Iniciando ProtexHome..."),!window.matchMedia("(display-mode: standalone)").matches){const t=document.createElement("div");t.id="splash-screen",t.innerHTML=`
        <div class="splash-content">
          <h1>ProtexHome</h1>
          <p>Protección Inteligente</p>
          <div class="splash-loader"></div>
        </div>
      `,document.body.prepend(t)}if(screen.orientation&&screen.orientation.lock)try{await screen.orientation.lock("portrait")}catch{}if(this.pwa=new cu,await Ey(t=>{var s,r;console.log("📩 Notificación en primer plano:",t);const i=t.data;i&&i.E!==void 0?(console.log("✅ Mostrando notificación nativa"),yy(i)):H_((((s=t.notification)==null?void 0:s.title)||"ProtexHome")+": "+(((r=t.notification)==null?void 0:r.body)||""),"info")}),window.addEventListener("popstate",()=>{this.activeView==="device"&&(Pt(),history.replaceState({view:"dashboard"},""),this.activeView="dashboard",this.showDashboard(this.currentUser))}),window.addEventListener("online",()=>{console.log("🟢 Conexión restaurada");const t=JSON.parse(localStorage.getItem("user")||"null");t&&t.uid&&document.getElementById("sites-list")&&this.showDashboard(t)}),document.addEventListener("visibilitychange",()=>this.handleVisibilityChange()),window.addEventListener("pagehide",()=>this.handleAppClose()),!navigator.onLine){console.log("⚠️ Sin conexión - Cargando offline"),this.showOfflineDashboard();return}this.setupAuthListener()}setupAuthListener(){Il(async e=>{var t,i;this.currentUser=e,e?e.emailVerified||((i=(t=e.providerData)==null?void 0:t[0])==null?void 0:i.providerId)==="google.com"?(console.log("✅ Dashboard"),this.showDashboardAfterSplash(e)):(console.log("⚠️ Verificación"),this.showVerificationAfterSplash(e)):(console.log("👤 Login"),this.showLoginAfterSplash())})}async loadAndPingModules(e){this.dashboardController||(this.dashboardController=new Go(e));const t=await this.dashboardController.loadSites();document.getElementById("sites-list")&&this.dashboardController.renderSites(t),Vi(e.uid,t.map(s=>s.serial)),this.dashboardController.pingAllModules(),this.dashboardController.startHealthCheck(e.uid),this.dashboardController.listenModulesStatus()}hideSplashAndShow(e){const t=document.getElementById("splash-screen");t?(t.style.opacity="0",t.style.transition="opacity 0.3s ease",setTimeout(()=>{t.remove(),e()},1)):e()}showDashboardAfterSplash(e){this.hideSplashAndShow(()=>this.showDashboard(e))}showVerificationAfterSplash(e){this.hideSplashAndShow(()=>this.showVerification(e))}showLoginAfterSplash(){this.hideSplashAndShow(()=>this.showLogin())}async showDashboard(e){this.stopActiveView(),this.activeView="dashboard",localStorage.setItem("user",JSON.stringify(e)),this.cachedDashboard={user:e,html:Pr};const t=document.getElementById("main-content");t.innerHTML=Pr,this.dashboardController=new Go(e);const i=document.getElementById("sites-list");i&&(i.innerHTML=`
        ${[1,2,3,4].map(()=>`
    ...
    `,(i=document.getElementById("check-verification-btn"))==null||i.addEventListener("click",async()=>{const{checkEmailVerification:r}=await fn(async()=>{const{checkEmailVerification:a}=await Promise.resolve().then(()=>jo);return{checkEmailVerification:a}},void 0,import.meta.url);(await r()).verified&&window.location.reload()}),(s=document.getElementById("logout-from-verify"))==null||s.addEventListener("click",async()=>await Kn())}showOfflineDashboard(){const e=document.getElementById("splash-screen");e&&(e.style.opacity="0",e.style.transition="opacity 0.2s ease",setTimeout(()=>e.remove(),150));const t=document.getElementById("main-content");t.innerHTML=au;const i=JSON.parse(localStorage.getItem("user")||"{}"),s=JSON.parse(localStorage.getItem("sites_"+i.uid)||"[]"),r=document.getElementById("offline-sites-list");r&&(s.length>0?r.innerHTML=s.map(a=>`
          <div class="site-card">
